...
final class BluetoothTests: XCTestCase {
    ...
    func testUUID() {
        ...
        do {
            ...
            XCTAssert(uuid.rawValue == "2800")
            XCTAssert(uuid.littleEndian == [0x00, 0x28])
            XCTAssert(uuid.littleEndian != [0x28, 0x00])
        ...
        do {
            ...
            XCTAssert(uuid.littleEndian == [0xC7, 0xA8, 0xD5, 0x70, 0xE0, 0x23, 0x4F, 0xB8, 0xE5, 0x11, 0x72, 0xF9, 0xE2, 0x4F, 0xF1, 0x60])
            //XCTAssert([UInt8](uuid.data) == [0x60, 0xF1, 0x4F, 0xE2, 0xF9, 0x72, 0x11, 0xE5, 0xB8, 0x4F, 0x23, 0xE0, 0x70, 0xD5, 0xA8, 0xC7])
