...
final class BluetoothTests: XCTestCase {
    ...
    func testLowEnergyAdvertisingData() {
        ...
        do {
            ...
            // zeroed data
            XCTAssertEqual(Data(LowEnergyAdvertisingData(data: Data())), Data())
            XCTAssertEqual(Data(LowEnergyAdvertisingData()), Data())
        ...
        do {
            ...
            XCTAssertEqual(Data(advertisingData).count, advertisingData.count)
