...
final class DefinedUUIDTests: XCTestCase {
    ...
    func testDefinedUUID() {
        ...
        /// SMK Corporation
        XCTAssertEqual(BluetoothUUID.smkCorporation.rawValue, "FDE5")
        XCTAssertEqual(BluetoothUUID.smkCorporation, .bit16(0xFDE5))
        XCTAssertEqual(BluetoothUUID.smkCorporation, .bit16(64997))
        XCTAssertEqual(BluetoothUUID.smkCorporation.name, "SMK Corporation")
        XCTAssertNotEqual(BluetoothUUID.smkCorporation, .bit32(64997))
        XCTAssertNotEqual(BluetoothUUID.smkCorporation, .bit32(0xFDE5))
        ...
        XCTAssertEqual(BluetoothUUID.spacesaverCorporation, .bit16(0xFDE9))
        XCTAssertEqual(BluetoothUUID.spacesaverCorporation, .bit16(65001))
        XCTAssertEqual(BluetoothUUID.spacesaverCorporation.name, "Spacesaver Corporation")
        XCTAssertNotEqual(BluetoothUUID.spacesaverCorporation, .bit32(65001))
        XCTAssertNotEqual(BluetoothUUID.spacesaverCorporation, .bit32(0xFDE9))
        ...
        XCTAssertEqual(BluetoothUUID.syntronixCorporation.rawValue, "FDEB")
        XCTAssertEqual(BluetoothUUID.syntronixCorporation, .bit16(0xFDEB))
        XCTAssertEqual(BluetoothUUID.syntronixCorporation, .bit16(65003))
        XCTAssertEqual(BluetoothUUID.syntronixCorporation.name, "Syntronix Corporation")
        XCTAssertNotEqual(BluetoothUUID.syntronixCorporation, .bit32(65003))
        XCTAssertNotEqual(BluetoothUUID.syntronixCorporation, .bit32(0xFDEB))

        /// Mannkind Corporation
        XCTAssertEqual(BluetoothUUID.mannkindCorporation.rawValue, "FDEC")
        XCTAssertEqual(BluetoothUUID.mannkindCorporation, .bit16(0xFDEC))
        XCTAssertEqual(BluetoothUUID.mannkindCorporation, .bit16(65004))
        XCTAssertEqual(BluetoothUUID.mannkindCorporation.name, "Mannkind Corporation")
        XCTAssertNotEqual(BluetoothUUID.mannkindCorporation, .bit32(65004))
        XCTAssertNotEqual(BluetoothUUID.mannkindCorporation, .bit32(0xFDEC))
        ...
        XCTAssertEqual(BluetoothUUID.amiccomElectronicsCorporation.rawValue, "FDF2")
        XCTAssertEqual(BluetoothUUID.amiccomElectronicsCorporation, .bit16(0xFDF2))
        XCTAssertEqual(BluetoothUUID.amiccomElectronicsCorporation, .bit16(65010))
        XCTAssertEqual(BluetoothUUID.amiccomElectronicsCorporation.name, "AMICCOM Electronics Corporation")
        XCTAssertNotEqual(BluetoothUUID.amiccomElectronicsCorporation, .bit32(65010))
        XCTAssertNotEqual(BluetoothUUID.amiccomElectronicsCorporation, .bit32(0xFDF2))
        ...
        /// AIAIAI ApS
        XCTAssertEqual(BluetoothUUID.aiaiaiAps.rawValue, "FDF6")
        XCTAssertEqual(BluetoothUUID.aiaiaiAps, .bit16(0xFDF6))
        XCTAssertEqual(BluetoothUUID.aiaiaiAps, .bit16(65014))
        XCTAssertEqual(BluetoothUUID.aiaiaiAps.name, "AIAIAI ApS")
        XCTAssertNotEqual(BluetoothUUID.aiaiaiAps, .bit32(65014))
        XCTAssertNotEqual(BluetoothUUID.aiaiaiAps, .bit32(0xFDF6))
        ...
        XCTAssertEqual(BluetoothUUID.coreTransportTechnologiesNzLimited.rawValue, "FE05")
        XCTAssertEqual(BluetoothUUID.coreTransportTechnologiesNzLimited, .bit16(0xFE05))
        XCTAssertEqual(BluetoothUUID.coreTransportTechnologiesNzLimited, .bit16(65029))
        XCTAssertEqual(BluetoothUUID.coreTransportTechnologiesNzLimited.name, "CORE Transport Technologies NZ Limited")
        XCTAssertNotEqual(BluetoothUUID.coreTransportTechnologiesNzLimited, .bit32(65029))
        XCTAssertNotEqual(BluetoothUUID.coreTransportTechnologiesNzLimited, .bit32(0xFE05))
        ...
        XCTAssertEqual(BluetoothUUID.illuminatiInstrumentCorporation.rawValue, "FE1D")
        XCTAssertEqual(BluetoothUUID.illuminatiInstrumentCorporation, .bit16(0xFE1D))
        XCTAssertEqual(BluetoothUUID.illuminatiInstrumentCorporation, .bit16(65053))
        XCTAssertEqual(BluetoothUUID.illuminatiInstrumentCorporation.name, "Illuminati Instrument Corporation")
        XCTAssertNotEqual(BluetoothUUID.illuminatiInstrumentCorporation, .bit32(65053))
        XCTAssertNotEqual(BluetoothUUID.illuminatiInstrumentCorporation, .bit32(0xFE1D))
        ...
        /// Bose Corporation
        XCTAssertEqual(BluetoothUUID.boseCorporation.rawValue, "FE21")
        XCTAssertEqual(BluetoothUUID.boseCorporation, .bit16(0xFE21))
        XCTAssertEqual(BluetoothUUID.boseCorporation, .bit16(65057))
        XCTAssertEqual(BluetoothUUID.boseCorporation.name, "Bose Corporation")
        XCTAssertNotEqual(BluetoothUUID.boseCorporation, .bit32(65057))
        XCTAssertNotEqual(BluetoothUUID.boseCorporation, .bit32(0xFE21))

        /// Zoll Medical Corporation
        XCTAssertEqual(BluetoothUUID.zollMedicalCorporation.rawValue, "FE22")
        XCTAssertEqual(BluetoothUUID.zollMedicalCorporation, .bit16(0xFE22))
        XCTAssertEqual(BluetoothUUID.zollMedicalCorporation, .bit16(65058))
        XCTAssertEqual(BluetoothUUID.zollMedicalCorporation.name, "Zoll Medical Corporation")
        XCTAssertNotEqual(BluetoothUUID.zollMedicalCorporation, .bit32(65058))
        XCTAssertNotEqual(BluetoothUUID.zollMedicalCorporation, .bit32(0xFE22))

        /// Zoll Medical Corporation
        XCTAssertEqual(BluetoothUUID.zollMedicalCorporation2.rawValue, "FE23")
        XCTAssertEqual(BluetoothUUID.zollMedicalCorporation2, .bit16(0xFE23))
        XCTAssertEqual(BluetoothUUID.zollMedicalCorporation2, .bit16(65059))
        XCTAssertEqual(BluetoothUUID.zollMedicalCorporation2.name, "Zoll Medical Corporation")
        XCTAssertNotEqual(BluetoothUUID.zollMedicalCorporation2, .bit32(65059))
        XCTAssertNotEqual(BluetoothUUID.zollMedicalCorporation2, .bit32(0xFE23))
        ...
        /// Friday Labs Limited
        XCTAssertEqual(BluetoothUUID.fridayLabsLimited.rawValue, "FE3F")
        XCTAssertEqual(BluetoothUUID.fridayLabsLimited, .bit16(0xFE3F))
        XCTAssertEqual(BluetoothUUID.fridayLabsLimited, .bit16(65087))
        XCTAssertEqual(BluetoothUUID.fridayLabsLimited.name, "Friday Labs Limited")
        XCTAssertNotEqual(BluetoothUUID.fridayLabsLimited, .bit32(65087))
        XCTAssertNotEqual(BluetoothUUID.fridayLabsLimited, .bit32(0xFE3F))

        /// Inugo Systems Limited
        XCTAssertEqual(BluetoothUUID.inugoSystemsLimited.rawValue, "FE40")
        XCTAssertEqual(BluetoothUUID.inugoSystemsLimited, .bit16(0xFE40))
        XCTAssertEqual(BluetoothUUID.inugoSystemsLimited, .bit16(65088))
        XCTAssertEqual(BluetoothUUID.inugoSystemsLimited.name, "Inugo Systems Limited")
        XCTAssertNotEqual(BluetoothUUID.inugoSystemsLimited, .bit32(65088))
        XCTAssertNotEqual(BluetoothUUID.inugoSystemsLimited, .bit32(0xFE40))

        /// Inugo Systems Limited
        XCTAssertEqual(BluetoothUUID.inugoSystemsLimited2.rawValue, "FE41")
        XCTAssertEqual(BluetoothUUID.inugoSystemsLimited2, .bit16(0xFE41))
        XCTAssertEqual(BluetoothUUID.inugoSystemsLimited2, .bit16(65089))
        XCTAssertEqual(BluetoothUUID.inugoSystemsLimited2.name, "Inugo Systems Limited")
        XCTAssertNotEqual(BluetoothUUID.inugoSystemsLimited2, .bit32(65089))
        ...
        /// SenionLab AB
        XCTAssertEqual(BluetoothUUID.senionlabAb.rawValue, "FE49")
        XCTAssertEqual(BluetoothUUID.senionlabAb, .bit16(0xFE49))
        XCTAssertEqual(BluetoothUUID.senionlabAb, .bit16(65097))
        XCTAssertEqual(BluetoothUUID.senionlabAb.name, "SenionLab AB")
        XCTAssertNotEqual(BluetoothUUID.senionlabAb, .bit32(65097))
        XCTAssertNotEqual(BluetoothUUID.senionlabAb, .bit32(0xFE49))
        ...
        XCTAssertEqual(BluetoothUUID.casambiTechnologiesOy, .bit16(0xFE4D))
        XCTAssertEqual(BluetoothUUID.casambiTechnologiesOy, .bit16(65101))
        XCTAssertEqual(BluetoothUUID.casambiTechnologiesOy.name, "Casambi Technologies Oy")
        XCTAssertNotEqual(BluetoothUUID.casambiTechnologiesOy, .bit32(65101))
        XCTAssertNotEqual(BluetoothUUID.casambiTechnologiesOy, .bit32(0xFE4D))
        ...
        XCTAssertEqual(BluetoothUUID.chronologicsCorporation, .bit16(0xFE5A))
        XCTAssertEqual(BluetoothUUID.chronologicsCorporation, .bit16(65114))
        XCTAssertEqual(BluetoothUUID.chronologicsCorporation.name, "Chronologics Corporation")
        XCTAssertNotEqual(BluetoothUUID.chronologicsCorporation, .bit32(65114))
        XCTAssertNotEqual(BluetoothUUID.chronologicsCorporation, .bit32(0xFE5A))
        ...
        XCTAssertEqual(BluetoothUUID.plastcCorporation, .bit16(0xFE5E))
        XCTAssertEqual(BluetoothUUID.plastcCorporation, .bit16(65118))
        XCTAssertEqual(BluetoothUUID.plastcCorporation.name, "Plastc Corporation")
        XCTAssertNotEqual(BluetoothUUID.plastcCorporation, .bit32(65118))
        XCTAssertNotEqual(BluetoothUUID.plastcCorporation, .bit32(0xFE5E))
        ...
        /// Bose Corporation
        XCTAssertEqual(BluetoothUUID.boseCorporation2.rawValue, "FEBE")
        XCTAssertEqual(BluetoothUUID.boseCorporation2, .bit16(0xFEBE))
        XCTAssertEqual(BluetoothUUID.boseCorporation2, .bit16(65214))
        XCTAssertEqual(BluetoothUUID.boseCorporation2.name, "Bose Corporation")
        XCTAssertNotEqual(BluetoothUUID.boseCorporation2, .bit32(65214))
        XCTAssertNotEqual(BluetoothUUID.boseCorporation2, .bit32(0xFEBE))
