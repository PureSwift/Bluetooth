...
final class GATTDescriptorTests: XCTestCase {
    ...
    func testCharacteristicsFormatDescriptor() {
        ...
        XCTAssertEqual(GATTFormatDescriptor(data: Data([0x00, 0x00, 0x00 , 0x00, 0x00, 0x00, 0x00]))?.format, CharacteristicFormatType.rfu)
        
        XCTAssertEqual(GATTFormatDescriptor(data: Data([0x17, 0x00, 0xAC, 0x27, 0x01, 0x00, 0x00]))?.format, CharacteristicFormatType.float)
