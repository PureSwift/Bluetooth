...
@Suite struct GATTCharacteristicTests {
    ...
    @Test func batteryLevel() {
        ...
        guard let percentage = GATTBatteryPercentage(rawValue: 34)
            ...
            Issue.record("Could not init Percentage")
            return
        }
    ...
    @Test func bodyCompositionMeasurement() {
        ...
        guard let kilogram = kg
            ...
            Issue.record("Could not init mass")
            return
        }
        guard let metre = mt
        else {
    ...
    @Test func systemID() {
        ...
        do {
            ...
            let manufacturerIdentifier: UInt40 = 0xFF_FE9A_BCDE
            let organizationallyUniqueIdentifier: UInt24 = 0x123456

            let characteristic = GATTSystemID(
        ...
        do {
            ...
            #expect(characteristic.manufacturerIdentifier == 0x0000_0000_0000_0000)
            #expect(characteristic.organizationallyUniqueIdentifier == 0x0000_0000_0000_0000)
            #expect(characteristic.description == "0000000000000000")
            #expect(characteristic.rawValue == 0x0000_0000_0000_0000)
        ...
        do {
            ...
            #expect(characteristic.manufacturerIdentifier == 1_099_511_627_775)
            #expect(characteristic.organizationallyUniqueIdentifier == 16_777_215)
            #expect(characteristic.description == "FFFFFFFFFFFFFFFF")
            #expect(characteristic.rawValue == 0xFFFF_FFFF_FFFF_FFFF)
            #expect(GATTSystemID(data: data) == GATTSystemID(data: data))
        }
    }
    ...
    @Test func crossTrainerData() {
        ...
        do {
            let data = Data([
                0b11111111, 0b01111111, 0x00,  // flags
            ...
            #expect(
                GATTCrossTrainerData(
                    instantaneousSpeed: 1285,
                    averageSpeed: 1285,
    ...
    @Test func dateUTC() {
        ...
        #expect(GATTDateUTC.Day(rawValue: 16_777_215) == nil)
