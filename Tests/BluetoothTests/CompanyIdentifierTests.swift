...
//  Bluetooth
//
//  Generated by Alsey Coleman Miller on 5/30/18.
//
...
final class CompanyIdentifierTests: XCTestCase {
    ...
    func testCompanies() {
        ...
        XCTAssertEqual(CompanyIdentifier.broadcomCorporation.rawValue, 15)
        XCTAssertEqual(CompanyIdentifier.broadcomCorporation.name, "Broadcom Corporation")
        XCTAssertEqual(CompanyIdentifier.broadcomCorporation.description, "Broadcom Corporation")
        ...
        /// Atmel Corporation
        XCTAssertEqual(CompanyIdentifier.atmelCorporation.rawValue, 19)
        XCTAssertEqual(CompanyIdentifier.atmelCorporation.name, "Atmel Corporation")
        XCTAssertEqual(CompanyIdentifier.atmelCorporation.description, "Atmel Corporation")

        /// Mitsubishi Electric Corporation
        XCTAssertEqual(CompanyIdentifier.mitsubishiElectricCorporation.rawValue, 20)
        XCTAssertEqual(CompanyIdentifier.mitsubishiElectricCorporation.name, "Mitsubishi Electric Corporation")
        XCTAssertEqual(CompanyIdentifier.mitsubishiElectricCorporation.description, "Mitsubishi Electric Corporation")
        ...
        /// TTPCom Limited
        XCTAssertEqual(CompanyIdentifier.ttpcomLimited.rawValue, 26)
        XCTAssertEqual(CompanyIdentifier.ttpcomLimited.name, "TTPCom Limited")
        XCTAssertEqual(CompanyIdentifier.ttpcomLimited.description, "TTPCom Limited")
        ...
        /// NEC Corporation
        XCTAssertEqual(CompanyIdentifier.necCorporation.rawValue, 34)
        XCTAssertEqual(CompanyIdentifier.necCorporation.name, "NEC Corporation")
        XCTAssertEqual(CompanyIdentifier.necCorporation.description, "NEC Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.computerAccessTechnologyCorporationCatc.rawValue, 52)
        XCTAssertEqual(CompanyIdentifier.computerAccessTechnologyCorporationCatc.name, "Computer Access Technology Corporation (CATC)")
        XCTAssertEqual(CompanyIdentifier.computerAccessTechnologyCorporationCatc.description, "Computer Access Technology Corporation (CATC)")
        ...
        XCTAssertEqual(CompanyIdentifier.renesasElectronicsCorporation.rawValue, 54)
        XCTAssertEqual(CompanyIdentifier.renesasElectronicsCorporation.name, "Renesas Electronics Corporation")
        XCTAssertEqual(CompanyIdentifier.renesasElectronicsCorporation.description, "Renesas Electronics Corporation")

        /// Mobilian Corporation
        XCTAssertEqual(CompanyIdentifier.mobilianCorporation.rawValue, 55)
        XCTAssertEqual(CompanyIdentifier.mobilianCorporation.name, "Mobilian Corporation")
        XCTAssertEqual(CompanyIdentifier.mobilianCorporation.description, "Mobilian Corporation")

        /// Syntronix Corporation
        XCTAssertEqual(CompanyIdentifier.syntronixCorporation.rawValue, 56)
        XCTAssertEqual(CompanyIdentifier.syntronixCorporation.name, "Syntronix Corporation")
        XCTAssertEqual(CompanyIdentifier.syntronixCorporation.description, "Syntronix Corporation")
        ...
        /// Gennum Corporation
        XCTAssertEqual(CompanyIdentifier.gennumCorporation.rawValue, 59)
        XCTAssertEqual(CompanyIdentifier.gennumCorporation.name, "Gennum Corporation")
        XCTAssertEqual(CompanyIdentifier.gennumCorporation.description, "Gennum Corporation")

        /// BlackBerry Limited (formerly Research In Motion)
        XCTAssertEqual(CompanyIdentifier.blackberryLimitedFormerlyResearchInMotion.rawValue, 60)
        XCTAssertEqual(CompanyIdentifier.blackberryLimitedFormerlyResearchInMotion.name, "BlackBerry Limited (formerly Research In Motion)")
        XCTAssertEqual(CompanyIdentifier.blackberryLimitedFormerlyResearchInMotion.description, "BlackBerry Limited (formerly Research In Motion)")
        ...
        XCTAssertEqual(CompanyIdentifier.seikoEpsonCorporation.rawValue, 64)
        XCTAssertEqual(CompanyIdentifier.seikoEpsonCorporation.name, "Seiko Epson Corporation")
        XCTAssertEqual(CompanyIdentifier.seikoEpsonCorporation.description, "Seiko Epson Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.conwiseTechnologyCorporation.rawValue, 66)
        XCTAssertEqual(CompanyIdentifier.conwiseTechnologyCorporation.name, "CONWISE Technology Corporation Ltd")
        XCTAssertEqual(CompanyIdentifier.conwiseTechnologyCorporation.description, "CONWISE Technology Corporation Ltd")
        ...
        /// 3DSP Corporation
        XCTAssertEqual(CompanyIdentifier.uuid3DspCorporation.rawValue, 73)
        XCTAssertEqual(CompanyIdentifier.uuid3DspCorporation.name, "3DSP Corporation")
        XCTAssertEqual(CompanyIdentifier.uuid3DspCorporation.description, "3DSP Corporation")
        ...
        /// J&M Corporation
        XCTAssertEqual(CompanyIdentifier.jMCorporation.rawValue, 82)
        XCTAssertEqual(CompanyIdentifier.jMCorporation.name, "J&M Corporation")
        XCTAssertEqual(CompanyIdentifier.jMCorporation.description, "J&M Corporation")

        /// Free2move AB
        XCTAssertEqual(CompanyIdentifier.free2MoveAb.rawValue, 83)
        XCTAssertEqual(CompanyIdentifier.free2MoveAb.name, "Free2move AB")
        XCTAssertEqual(CompanyIdentifier.free2MoveAb.description, "Free2move AB")

        /// 3DiJoy Corporation
        XCTAssertEqual(CompanyIdentifier.uuid3DijoyCorporation.rawValue, 84)
        XCTAssertEqual(CompanyIdentifier.uuid3DijoyCorporation.name, "3DiJoy Corporation")
        XCTAssertEqual(CompanyIdentifier.uuid3DijoyCorporation.description, "3DiJoy Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.ralinkTechnologyCorporation.rawValue, 91)
        XCTAssertEqual(CompanyIdentifier.ralinkTechnologyCorporation.name, "Ralink Technology Corporation")
        XCTAssertEqual(CompanyIdentifier.ralinkTechnologyCorporation.description, "Ralink Technology Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.realtekSemiconductorCorporation.rawValue, 93)
        XCTAssertEqual(CompanyIdentifier.realtekSemiconductorCorporation.name, "Realtek Semiconductor Corporation")
        XCTAssertEqual(CompanyIdentifier.realtekSemiconductorCorporation.description, "Realtek Semiconductor Corporation")
        ...
        /// 9Solutions Oy
        XCTAssertEqual(CompanyIdentifier.uuid9SolutionsOy.rawValue, 102)
        XCTAssertEqual(CompanyIdentifier.uuid9SolutionsOy.name, "9Solutions Oy")
        XCTAssertEqual(CompanyIdentifier.uuid9SolutionsOy.description, "9Solutions Oy")
        ...
        /// connectBlue AB
        XCTAssertEqual(CompanyIdentifier.connectblueAb.rawValue, 113)
        XCTAssertEqual(CompanyIdentifier.connectblueAb.name, "connectBlue AB")
        XCTAssertEqual(CompanyIdentifier.connectblueAb.description, "connectBlue AB")
        ...
        /// Bose Corporation
        XCTAssertEqual(CompanyIdentifier.boseCorporation.rawValue, 158)
        XCTAssertEqual(CompanyIdentifier.boseCorporation.name, "Bose Corporation")
        XCTAssertEqual(CompanyIdentifier.boseCorporation.description, "Bose Corporation")

        /// Suunto Oy
        XCTAssertEqual(CompanyIdentifier.suuntoOy.rawValue, 159)
        XCTAssertEqual(CompanyIdentifier.suuntoOy.name, "Suunto Oy")
        XCTAssertEqual(CompanyIdentifier.suuntoOy.description, "Suunto Oy")
        ...
        XCTAssertEqual(CompanyIdentifier.vertuCorporationLimited.rawValue, 162)
        XCTAssertEqual(CompanyIdentifier.vertuCorporationLimited.name, "Vertu Corporation Limited")
        XCTAssertEqual(CompanyIdentifier.vertuCorporationLimited.description, "Vertu Corporation Limited")
        ...
        /// Visteon Corporation
        XCTAssertEqual(CompanyIdentifier.visteonCorporation.rawValue, 167)
        XCTAssertEqual(CompanyIdentifier.visteonCorporation.name, "Visteon Corporation")
        XCTAssertEqual(CompanyIdentifier.visteonCorporation.description, "Visteon Corporation")

        /// ARP Devices Limited
        XCTAssertEqual(CompanyIdentifier.arpDevicesLimited.rawValue, 168)
        XCTAssertEqual(CompanyIdentifier.arpDevicesLimited.name, "ARP Devices Limited")
        XCTAssertEqual(CompanyIdentifier.arpDevicesLimited.description, "ARP Devices Limited")
        ...
        /// Omegawave Oy
        XCTAssertEqual(CompanyIdentifier.omegawaveOy.rawValue, 174)
        XCTAssertEqual(CompanyIdentifier.omegawaveOy.name, "Omegawave Oy")
        XCTAssertEqual(CompanyIdentifier.omegawaveOy.description, "Omegawave Oy")
        ...
        XCTAssertEqual(CompanyIdentifier.passifSemiconductorCorp.rawValue, 176)
        XCTAssertEqual(CompanyIdentifier.passifSemiconductorCorp.name, "Passif Semiconductor Corp")
        XCTAssertEqual(CompanyIdentifier.passifSemiconductorCorp.description, "Passif Semiconductor Corp")
        ...
        XCTAssertEqual(CompanyIdentifier.sPowerElectronicsLimited.rawValue, 187)
        XCTAssertEqual(CompanyIdentifier.sPowerElectronicsLimited.name, "S-Power Electronics Limited")
        XCTAssertEqual(CompanyIdentifier.sPowerElectronicsLimited.description, "S-Power Electronics Limited")
        ...
        /// Aplix Corporation
        XCTAssertEqual(CompanyIdentifier.aplixCorporation.rawValue, 189)
        XCTAssertEqual(CompanyIdentifier.aplixCorporation.name, "Aplix Corporation")
        XCTAssertEqual(CompanyIdentifier.aplixCorporation.description, "Aplix Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.stalmartTechnologyLimited.rawValue, 191)
        XCTAssertEqual(CompanyIdentifier.stalmartTechnologyLimited.name, "Stalmart Technology Limited")
        XCTAssertEqual(CompanyIdentifier.stalmartTechnologyLimited.description, "Stalmart Technology Limited")

        /// AMICCOM Electronics Corporation
        XCTAssertEqual(CompanyIdentifier.amiccomElectronicsCorporation.rawValue, 192)
        XCTAssertEqual(CompanyIdentifier.amiccomElectronicsCorporation.name, "AMICCOM Electronics Corporation")
        XCTAssertEqual(CompanyIdentifier.amiccomElectronicsCorporation.description, "AMICCOM Electronics Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.onsetComputerCorporation.rawValue, 197)
        XCTAssertEqual(CompanyIdentifier.onsetComputerCorporation.name, "Onset Computer Corporation")
        XCTAssertEqual(CompanyIdentifier.onsetComputerCorporation.description, "Onset Computer Corporation")

        /// Selfly BV
        XCTAssertEqual(CompanyIdentifier.selflyBv.rawValue, 198)
        XCTAssertEqual(CompanyIdentifier.selflyBv.name, "Selfly BV")
        XCTAssertEqual(CompanyIdentifier.selflyBv.description, "Selfly BV")

        /// Quuppa Oy.
        XCTAssertEqual(CompanyIdentifier.quuppaOy.rawValue, 199)
        XCTAssertEqual(CompanyIdentifier.quuppaOy.name, "Quuppa Oy.")
        XCTAssertEqual(CompanyIdentifier.quuppaOy.description, "Quuppa Oy.")
        ...
        /// Hosiden Corporation
        XCTAssertEqual(CompanyIdentifier.hosidenCorporation.rawValue, 221)
        XCTAssertEqual(CompanyIdentifier.hosidenCorporation.name, "Hosiden Corporation")
        XCTAssertEqual(CompanyIdentifier.hosidenCorporation.description, "Hosiden Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.misfitWearablesCorp.rawValue, 223)
        XCTAssertEqual(CompanyIdentifier.misfitWearablesCorp.name, "Misfit Wearables Corp")
        XCTAssertEqual(CompanyIdentifier.misfitWearablesCorp.description, "Misfit Wearables Corp")
        ...
        XCTAssertEqual(CompanyIdentifier.witronTechnologyLimited.rawValue, 241)
        XCTAssertEqual(CompanyIdentifier.witronTechnologyLimited.name, "Witron Technology Limited")
        XCTAssertEqual(CompanyIdentifier.witronTechnologyLimited.description, "Witron Technology Limited")
        ...
        /// Smartifier Oy
        XCTAssertEqual(CompanyIdentifier.smartifierOy.rawValue, 245)
        XCTAssertEqual(CompanyIdentifier.smartifierOy.name, "Smartifier Oy")
        XCTAssertEqual(CompanyIdentifier.smartifierOy.description, "Smartifier Oy")

        /// Elcometer Limited
        XCTAssertEqual(CompanyIdentifier.elcometerLimited.rawValue, 246)
        XCTAssertEqual(CompanyIdentifier.elcometerLimited.name, "Elcometer Limited")
        XCTAssertEqual(CompanyIdentifier.elcometerLimited.description, "Elcometer Limited")
        ...
        /// Crystal Code AB
        XCTAssertEqual(CompanyIdentifier.crystalCodeAb.rawValue, 250)
        XCTAssertEqual(CompanyIdentifier.crystalCodeAb.name, "Crystal Code AB")
        XCTAssertEqual(CompanyIdentifier.crystalCodeAb.description, "Crystal Code AB")
        ...
        /// Delphi Corporation
        XCTAssertEqual(CompanyIdentifier.delphiCorporation.rawValue, 252)
        XCTAssertEqual(CompanyIdentifier.delphiCorporation.name, "Delphi Corporation")
        XCTAssertEqual(CompanyIdentifier.delphiCorporation.description, "Delphi Corporation")

        /// ValenceTech Limited
        XCTAssertEqual(CompanyIdentifier.valencetechLimited.rawValue, 253)
        XCTAssertEqual(CompanyIdentifier.valencetechLimited.name, "ValenceTech Limited")
        XCTAssertEqual(CompanyIdentifier.valencetechLimited.description, "ValenceTech Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.tomtomInternationalBv.rawValue, 256)
        XCTAssertEqual(CompanyIdentifier.tomtomInternationalBv.name, "TomTom International BV")
        XCTAssertEqual(CompanyIdentifier.tomtomInternationalBv.description, "TomTom International BV")
        ...
        /// Keiser Corporation
        XCTAssertEqual(CompanyIdentifier.keiserCorporation.rawValue, 258)
        XCTAssertEqual(CompanyIdentifier.keiserCorporation.name, "Keiser Corporation")
        XCTAssertEqual(CompanyIdentifier.keiserCorporation.description, "Keiser Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.ubiquitousComputingTechnologyCorporation.rawValue, 261)
        XCTAssertEqual(CompanyIdentifier.ubiquitousComputingTechnologyCorporation.name, "Ubiquitous Computing Technology Corporation")
        XCTAssertEqual(CompanyIdentifier.ubiquitousComputingTechnologyCorporation.description, "Ubiquitous Computing Technology Corporation")
        ...
        /// Atus BV
        XCTAssertEqual(CompanyIdentifier.atusBv.rawValue, 265)
        XCTAssertEqual(CompanyIdentifier.atusBv.name, "Atus BV")
        XCTAssertEqual(CompanyIdentifier.atusBv.description, "Atus BV")
        ...
        /// Fujitsu Ten Limited
        XCTAssertEqual(CompanyIdentifier.fujitsuTenLimited.rawValue, 269)
        XCTAssertEqual(CompanyIdentifier.fujitsuTenLimited.name, "Fujitsu Ten Limited")
        XCTAssertEqual(CompanyIdentifier.fujitsuTenLimited.description, "Fujitsu Ten Limited")
        ...
        /// Steelseries ApS
        XCTAssertEqual(CompanyIdentifier.steelseriesAps.rawValue, 273)
        XCTAssertEqual(CompanyIdentifier.steelseriesAps.name, "Steelseries ApS")
        XCTAssertEqual(CompanyIdentifier.steelseriesAps.description, "Steelseries ApS")
        ...
        /// Nimble Devices Oy
        XCTAssertEqual(CompanyIdentifier.nimbleDevicesOy.rawValue, 297)
        XCTAssertEqual(CompanyIdentifier.nimbleDevicesOy.name, "Nimble Devices Oy")
        XCTAssertEqual(CompanyIdentifier.nimbleDevicesOy.description, "Nimble Devices Oy")
        ...
        /// Sony Corporation
        XCTAssertEqual(CompanyIdentifier.sonyCorporation.rawValue, 301)
        XCTAssertEqual(CompanyIdentifier.sonyCorporation.name, "Sony Corporation")
        XCTAssertEqual(CompanyIdentifier.sonyCorporation.description, "Sony Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.cypressSemiconductorCorporation.rawValue, 305)
        XCTAssertEqual(CompanyIdentifier.cypressSemiconductorCorporation.name, "Cypress Semiconductor Corporation")
        XCTAssertEqual(CompanyIdentifier.cypressSemiconductorCorporation.description, "Cypress Semiconductor Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.blueMaestroLimited.rawValue, 307)
        XCTAssertEqual(CompanyIdentifier.blueMaestroLimited.name, "Blue Maestro Limited")
        XCTAssertEqual(CompanyIdentifier.blueMaestroLimited.description, "Blue Maestro Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.focusSystemsCorporation.rawValue, 313)
        XCTAssertEqual(CompanyIdentifier.focusSystemsCorporation.name, "Focus Systems Corporation")
        XCTAssertEqual(CompanyIdentifier.focusSystemsCorporation.description, "Focus Systems Corporation")

        /// Tencent Holdings Limited
        XCTAssertEqual(CompanyIdentifier.tencentHoldingsLimited.rawValue, 314)
        XCTAssertEqual(CompanyIdentifier.tencentHoldingsLimited.name, "Tencent Holdings Limited")
        XCTAssertEqual(CompanyIdentifier.tencentHoldingsLimited.description, "Tencent Holdings Limited")
        ...
        /// Pioneer Corporation
        XCTAssertEqual(CompanyIdentifier.pioneerCorporation.rawValue, 336)
        XCTAssertEqual(CompanyIdentifier.pioneerCorporation.name, "Pioneer Corporation")
        XCTAssertEqual(CompanyIdentifier.pioneerCorporation.description, "Pioneer Corporation")
        ...
        /// Accumulate AB
        XCTAssertEqual(CompanyIdentifier.accumulateAb.rawValue, 342)
        XCTAssertEqual(CompanyIdentifier.accumulateAb.name, "Accumulate AB")
        XCTAssertEqual(CompanyIdentifier.accumulateAb.description, "Accumulate AB")
        ...
        /// Inmite s.r.o.
        XCTAssertEqual(CompanyIdentifier.inmiteSRO.rawValue, 344)
        XCTAssertEqual(CompanyIdentifier.inmiteSRO.name, "Inmite s.r.o.")
        XCTAssertEqual(CompanyIdentifier.inmiteSRO.description, "Inmite s.r.o.")
        ...
        XCTAssertEqual(CompanyIdentifier.cooperAtkinsCorporation.rawValue, 362)
        XCTAssertEqual(CompanyIdentifier.cooperAtkinsCorporation.name, "Cooper-Atkins Corporation")
        XCTAssertEqual(CompanyIdentifier.cooperAtkinsCorporation.description, "Cooper-Atkins Corporation")
        ...
        /// Volantic AB
        XCTAssertEqual(CompanyIdentifier.volanticAb.rawValue, 366)
        XCTAssertEqual(CompanyIdentifier.volanticAb.name, "Volantic AB")
        XCTAssertEqual(CompanyIdentifier.volanticAb.description, "Volantic AB")
        ...
        XCTAssertEqual(CompanyIdentifier.connovateTechnologyPrivateLimited.rawValue, 370)
        XCTAssertEqual(CompanyIdentifier.connovateTechnologyPrivateLimited.name, "Connovate Technology Private Limited")
        XCTAssertEqual(CompanyIdentifier.connovateTechnologyPrivateLimited.description, "Connovate Technology Private Limited")
        ...
        /// XTel Wireless ApS
        XCTAssertEqual(CompanyIdentifier.xtelWirelessAps.rawValue, 383)
        XCTAssertEqual(CompanyIdentifier.xtelWirelessAps.name, "XTel Wireless ApS")
        XCTAssertEqual(CompanyIdentifier.xtelWirelessAps.description, "XTel Wireless ApS")
        ...
        XCTAssertEqual(CompanyIdentifier.ableTrendTechnologyLimited.rawValue, 394)
        XCTAssertEqual(CompanyIdentifier.ableTrendTechnologyLimited.name, "Able Trend Technology Limited")
        XCTAssertEqual(CompanyIdentifier.ableTrendTechnologyLimited.description, "Able Trend Technology Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.acousticStreamCorporation.rawValue, 404)
        XCTAssertEqual(CompanyIdentifier.acousticStreamCorporation.name, "Acoustic Stream Corporation")
        XCTAssertEqual(CompanyIdentifier.acousticStreamCorporation.description, "Acoustic Stream Corporation")
        ...
        /// CUBETECH s.r.o.
        XCTAssertEqual(CompanyIdentifier.cubetechSRO.rawValue, 411)
        XCTAssertEqual(CompanyIdentifier.cubetechSRO.name, "CUBETECH s.r.o.")
        ...
        /// Earlens Corporation
        XCTAssertEqual(CompanyIdentifier.earlensCorporation.rawValue, 430)
        XCTAssertEqual(CompanyIdentifier.earlensCorporation.name, "Earlens Corporation")
        XCTAssertEqual(CompanyIdentifier.earlensCorporation.description, "Earlens Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.cochlearBoneAnchoredSolutionsAb.rawValue, 443)
        XCTAssertEqual(CompanyIdentifier.cochlearBoneAnchoredSolutionsAb.name, "Cochlear Bone Anchored Solutions AB")
        XCTAssertEqual(CompanyIdentifier.cochlearBoneAnchoredSolutionsAb.description, "Cochlear Bone Anchored Solutions AB")

        /// SenionLab AB
        XCTAssertEqual(CompanyIdentifier.senionlabAb.rawValue, 444)
        XCTAssertEqual(CompanyIdentifier.senionlabAb.name, "SenionLab AB")
        XCTAssertEqual(CompanyIdentifier.senionlabAb.description, "SenionLab AB")
        ...
        XCTAssertEqual(CompanyIdentifier.hongKongHuntersunElectronicLimited.rawValue, 447)
        XCTAssertEqual(CompanyIdentifier.hongKongHuntersunElectronicLimited.name, "Hong Kong HunterSun Electronic Limited")
        XCTAssertEqual(CompanyIdentifier.hongKongHuntersunElectronicLimited.description, "Hong Kong HunterSun Electronic Limited")
        ...
        /// Bitcraze AB
        XCTAssertEqual(CompanyIdentifier.bitcrazeAb.rawValue, 453)
        XCTAssertEqual(CompanyIdentifier.bitcrazeAb.name, "Bitcraze AB")
        XCTAssertEqual(CompanyIdentifier.bitcrazeAb.description, "Bitcraze AB")
        ...
        /// Poly-Control ApS
        XCTAssertEqual(CompanyIdentifier.polyControlAps.rawValue, 456)
        XCTAssertEqual(CompanyIdentifier.polyControlAps.name, "Poly-Control ApS")
        XCTAssertEqual(CompanyIdentifier.polyControlAps.description, "Poly-Control ApS")
        ...
        /// Laerdal Medical AS
        XCTAssertEqual(CompanyIdentifier.laerdalMedicalAs.rawValue, 458)
        XCTAssertEqual(CompanyIdentifier.laerdalMedicalAs.name, "Laerdal Medical AS")
        XCTAssertEqual(CompanyIdentifier.laerdalMedicalAs.description, "Laerdal Medical AS")
        ...
        /// Code Corporation
        XCTAssertEqual(CompanyIdentifier.codeCorporation.rawValue, 472)
        XCTAssertEqual(CompanyIdentifier.codeCorporation.name, "Code Corporation")
        XCTAssertEqual(CompanyIdentifier.codeCorporation.description, "Code Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.minelabElectronicsPtyLimited.rawValue, 478)
        XCTAssertEqual(CompanyIdentifier.minelabElectronicsPtyLimited.name, "Minelab Electronics Pty Limited")
        XCTAssertEqual(CompanyIdentifier.minelabElectronicsPtyLimited.description, "Minelab Electronics Pty Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.zebraTechnologiesCorporation.rawValue, 497)
        XCTAssertEqual(CompanyIdentifier.zebraTechnologiesCorporation.name, "Zebra Technologies Corporation")
        XCTAssertEqual(CompanyIdentifier.zebraTechnologiesCorporation.description, "Zebra Technologies Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.coolWebthingsLimited.rawValue, 501)
        XCTAssertEqual(CompanyIdentifier.coolWebthingsLimited.name, "Cool Webthings Limited")
        XCTAssertEqual(CompanyIdentifier.coolWebthingsLimited.description, "Cool Webthings Limited")
        ...
        /// Gelliner Limited
        XCTAssertEqual(CompanyIdentifier.gellinerLimited.rawValue, 503)
        XCTAssertEqual(CompanyIdentifier.gellinerLimited.name, "Gelliner Limited")
        XCTAssertEqual(CompanyIdentifier.gellinerLimited.description, "Gelliner Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.radioSystemCorporation.rawValue, 510)
        XCTAssertEqual(CompanyIdentifier.radioSystemCorporation.name, "Radio System Corporation")
        XCTAssertEqual(CompanyIdentifier.radioSystemCorporation.description, "Radio System Corporation")
        ...
        /// Kemppi Oy
        XCTAssertEqual(CompanyIdentifier.kemppiOy.rawValue, 515)
        XCTAssertEqual(CompanyIdentifier.kemppiOy.name, "Kemppi Oy")
        XCTAssertEqual(CompanyIdentifier.kemppiOy.description, "Kemppi Oy")
        ...
        XCTAssertEqual(CompanyIdentifier.jaguarLandRoverLimited.rawValue, 523)
        XCTAssertEqual(CompanyIdentifier.jaguarLandRoverLimited.name, "Jaguar Land Rover Limited")
        XCTAssertEqual(CompanyIdentifier.jaguarLandRoverLimited.description, "Jaguar Land Rover Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.lukotonExperienceOy.rawValue, 533)
        XCTAssertEqual(CompanyIdentifier.lukotonExperienceOy.name, "Lukoton Experience Oy")
        XCTAssertEqual(CompanyIdentifier.lukotonExperienceOy.description, "Lukoton Experience Oy")
        ...
        /// Hiotech AB
        XCTAssertEqual(CompanyIdentifier.hiotechAb.rawValue, 536)
        XCTAssertEqual(CompanyIdentifier.hiotechAb.name, "Hiotech AB")
        XCTAssertEqual(CompanyIdentifier.hiotechAb.description, "Hiotech AB")

        /// DOTT Limited
        XCTAssertEqual(CompanyIdentifier.dottLimited.rawValue, 537)
        XCTAssertEqual(CompanyIdentifier.dottLimited.name, "DOTT Limited")
        XCTAssertEqual(CompanyIdentifier.dottLimited.description, "DOTT Limited")
        ...
        /// Manus Machina BV
        XCTAssertEqual(CompanyIdentifier.manusMachinaBv.rawValue, 544)
        XCTAssertEqual(CompanyIdentifier.manusMachinaBv.name, "Manus Machina BV")
        XCTAssertEqual(CompanyIdentifier.manusMachinaBv.description, "Manus Machina BV")
        ...
        /// Muoverti Limited
        XCTAssertEqual(CompanyIdentifier.muovertiLimited.rawValue, 553)
        XCTAssertEqual(CompanyIdentifier.muovertiLimited.name, "Muoverti Limited")
        XCTAssertEqual(CompanyIdentifier.muovertiLimited.description, "Muoverti Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.pharynksCorporation.rawValue, 556)
        XCTAssertEqual(CompanyIdentifier.pharynksCorporation.name, "Pharynks Corporation")
        XCTAssertEqual(CompanyIdentifier.pharynksCorporation.description, "Pharynks Corporation")
        ...
        /// Masimo Corp
        XCTAssertEqual(CompanyIdentifier.masimoCorp.rawValue, 579)
        XCTAssertEqual(CompanyIdentifier.masimoCorp.name, "Masimo Corp")
        XCTAssertEqual(CompanyIdentifier.masimoCorp.description, "Masimo Corp")
        ...
        XCTAssertEqual(CompanyIdentifier.parkerHannifinCorp.rawValue, 584)
        XCTAssertEqual(CompanyIdentifier.parkerHannifinCorp.name, "Parker Hannifin Corp")
        XCTAssertEqual(CompanyIdentifier.parkerHannifinCorp.description, "Parker Hannifin Corp")
        ...
        /// G24 Power Limited
        XCTAssertEqual(CompanyIdentifier.g24PowerLimited.rawValue, 598)
        XCTAssertEqual(CompanyIdentifier.g24PowerLimited.name, "G24 Power Limited")
        XCTAssertEqual(CompanyIdentifier.g24PowerLimited.description, "G24 Power Limited")
        ...
        /// Fluke Corporation
        XCTAssertEqual(CompanyIdentifier.flukeCorporation.rawValue, 606)
        XCTAssertEqual(CompanyIdentifier.flukeCorporation.name, "Fluke Corporation")
        XCTAssertEqual(CompanyIdentifier.flukeCorporation.description, "Fluke Corporation")
        ...
        /// SMK Corporation
        XCTAssertEqual(CompanyIdentifier.smkCorporation.rawValue, 613)
        XCTAssertEqual(CompanyIdentifier.smkCorporation.name, "SMK Corporation")
        XCTAssertEqual(CompanyIdentifier.smkCorporation.description, "SMK Corporation")
        ...
        /// Torrox GmbH & Co KG
        XCTAssertEqual(CompanyIdentifier.torroxCoKg.rawValue, 617)
        XCTAssertEqual(CompanyIdentifier.torroxCoKg.name, "Torrox GmbH & Co KG")
        XCTAssertEqual(CompanyIdentifier.torroxCoKg.description, "Torrox GmbH & Co KG")
        ...
        /// FLEURBAEY BVBA
        XCTAssertEqual(CompanyIdentifier.fleurbaeyBvba.rawValue, 622)
        XCTAssertEqual(CompanyIdentifier.fleurbaeyBvba.name, "FLEURBAEY BVBA")
        XCTAssertEqual(CompanyIdentifier.fleurbaeyBvba.description, "FLEURBAEY BVBA")
        ...
        /// Animas Corp
        XCTAssertEqual(CompanyIdentifier.animasCorp.rawValue, 625)
        XCTAssertEqual(CompanyIdentifier.animasCorp.name, "Animas Corp")
        XCTAssertEqual(CompanyIdentifier.animasCorp.description, "Animas Corp")
        ...
        /// DEFA AS
        XCTAssertEqual(CompanyIdentifier.defaAs.rawValue, 635)
        XCTAssertEqual(CompanyIdentifier.defaAs.name, "DEFA AS")
        XCTAssertEqual(CompanyIdentifier.defaAs.description, "DEFA AS")
        ...
        /// Jetro AS
        XCTAssertEqual(CompanyIdentifier.jetroAs.rawValue, 650)
        XCTAssertEqual(CompanyIdentifier.jetroAs.name, "Jetro AS")
        XCTAssertEqual(CompanyIdentifier.jetroAs.description, "Jetro AS")
        ...
        /// RF Digital Corp
        XCTAssertEqual(CompanyIdentifier.rfDigitalCorp.rawValue, 654)
        XCTAssertEqual(CompanyIdentifier.rfDigitalCorp.name, "RF Digital Corp")
        XCTAssertEqual(CompanyIdentifier.rfDigitalCorp.description, "RF Digital Corp")
        ...
        /// Multibit Oy
        XCTAssertEqual(CompanyIdentifier.multibitOy.rawValue, 656)
        XCTAssertEqual(CompanyIdentifier.multibitOy.name, "Multibit Oy")
        XCTAssertEqual(CompanyIdentifier.multibitOy.description, "Multibit Oy")
        ...
        /// storm power ltd
        XCTAssertEqual(CompanyIdentifier.stormPowerLtd.rawValue, 663)
        XCTAssertEqual(CompanyIdentifier.stormPowerLtd.name, "storm power ltd")
        XCTAssertEqual(CompanyIdentifier.stormPowerLtd.description, "storm power ltd")
        ...
        XCTAssertEqual(CompanyIdentifier.tendyronCorporation天地融科技股份有限公司.rawValue, 677)
        XCTAssertEqual(CompanyIdentifier.tendyronCorporation天地融科技股份有限公司.name, "Tendyron Corporation ( 天地融科技股份有限公司 )")
        XCTAssertEqual(CompanyIdentifier.tendyronCorporation天地融科技股份有限公司.description, "Tendyron Corporation ( 天地融科技股份有限公司 )")
        ...
        /// BBPOS Limited
        XCTAssertEqual(CompanyIdentifier.bbposLimited.rawValue, 683)
        XCTAssertEqual(CompanyIdentifier.bbposLimited.name, "BBPOS Limited")
        XCTAssertEqual(CompanyIdentifier.bbposLimited.description, "BBPOS Limited")
        ...
        /// JouZen Oy
        XCTAssertEqual(CompanyIdentifier.jouzenOy.rawValue, 690)
        XCTAssertEqual(CompanyIdentifier.jouzenOy.name, "JouZen Oy")
        XCTAssertEqual(CompanyIdentifier.jouzenOy.description, "JouZen Oy")
        ...
        XCTAssertEqual(CompanyIdentifier.hanshinElectricRailwayCoLtd.rawValue, 693)
        XCTAssertEqual(CompanyIdentifier.hanshinElectricRailwayCoLtd.name, "HANSHIN ELECTRIC RAILWAY CO.,LTD.")
        XCTAssertEqual(CompanyIdentifier.hanshinElectricRailwayCoLtd.description, "HANSHIN ELECTRIC RAILWAY CO.,LTD.")
        ...
        /// Rinnai Corporation
        XCTAssertEqual(CompanyIdentifier.rinnaiCorporation.rawValue, 697)
        XCTAssertEqual(CompanyIdentifier.rinnaiCorporation.name, "Rinnai Corporation")
        XCTAssertEqual(CompanyIdentifier.rinnaiCorporation.description, "Rinnai Corporation")
        ...
        /// Koha.,Co.Ltd
        XCTAssertEqual(CompanyIdentifier.kohaCoLtd.rawValue, 699)
        XCTAssertEqual(CompanyIdentifier.kohaCoLtd.name, "Koha.,Co.Ltd")
        XCTAssertEqual(CompanyIdentifier.kohaCoLtd.description, "Koha.,Co.Ltd")
        ...
        /// LINE Corporation
        XCTAssertEqual(CompanyIdentifier.lineCorporation.rawValue, 705)
        XCTAssertEqual(CompanyIdentifier.lineCorporation.name, "LINE Corporation")
        XCTAssertEqual(CompanyIdentifier.lineCorporation.description, "LINE Corporation")

        /// Guillemot Corporation
        XCTAssertEqual(CompanyIdentifier.guillemotCorporation.rawValue, 706)
        XCTAssertEqual(CompanyIdentifier.guillemotCorporation.name, "Guillemot Corporation")
        XCTAssertEqual(CompanyIdentifier.guillemotCorporation.description, "Guillemot Corporation")

        /// Techtronic Power Tools Technology Limited
        XCTAssertEqual(CompanyIdentifier.techtronicPowerToolsTechnologyLimited.rawValue, 707)
        XCTAssertEqual(CompanyIdentifier.techtronicPowerToolsTechnologyLimited.name, "Techtronic Power Tools Technology Limited")
        XCTAssertEqual(CompanyIdentifier.techtronicPowerToolsTechnologyLimited.description, "Techtronic Power Tools Technology Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.electronicsTomorrowLimited.rawValue, 711)
        XCTAssertEqual(CompanyIdentifier.electronicsTomorrowLimited.name, "Electronics Tomorrow Limited")
        XCTAssertEqual(CompanyIdentifier.electronicsTomorrowLimited.description, "Electronics Tomorrow Limited")
        ...
        /// BMA ergonomics b.v.
        XCTAssertEqual(CompanyIdentifier.bmaErgonomicsBV.rawValue, 717)
        XCTAssertEqual(CompanyIdentifier.bmaErgonomicsBV.name, "BMA ergonomics b.v.")
        XCTAssertEqual(CompanyIdentifier.bmaErgonomicsBV.description, "BMA ergonomics b.v.")
        ...
        /// Empatica Srl
        XCTAssertEqual(CompanyIdentifier.empaticaSrl.rawValue, 721)
        XCTAssertEqual(CompanyIdentifier.empaticaSrl.name, "Empatica Srl")
        XCTAssertEqual(CompanyIdentifier.empaticaSrl.description, "Empatica Srl")
        ...
        XCTAssertEqual(CompanyIdentifier.powercastCorporation.rawValue, 723)
        XCTAssertEqual(CompanyIdentifier.powercastCorporation.name, "Powercast Corporation")
        XCTAssertEqual(CompanyIdentifier.powercastCorporation.description, "Powercast Corporation")

        /// Secuyou ApS
        XCTAssertEqual(CompanyIdentifier.secuyouAps.rawValue, 724)
        XCTAssertEqual(CompanyIdentifier.secuyouAps.name, "Secuyou ApS")
        XCTAssertEqual(CompanyIdentifier.secuyouAps.description, "Secuyou ApS")

        /// OMRON Corporation
        XCTAssertEqual(CompanyIdentifier.omronCorporation.rawValue, 725)
        XCTAssertEqual(CompanyIdentifier.omronCorporation.name, "OMRON Corporation")
        XCTAssertEqual(CompanyIdentifier.omronCorporation.description, "OMRON Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.nipponSystemwareCoLtd.rawValue, 727)
        XCTAssertEqual(CompanyIdentifier.nipponSystemwareCoLtd.name, "NIPPON SYSTEMWARE CO.,LTD.")
        XCTAssertEqual(CompanyIdentifier.nipponSystemwareCoLtd.description, "NIPPON SYSTEMWARE CO.,LTD.")
        ...
        /// Victron Energy BV
        XCTAssertEqual(CompanyIdentifier.victronEnergyBv.rawValue, 737)
        XCTAssertEqual(CompanyIdentifier.victronEnergyBv.name, "Victron Energy BV")
        XCTAssertEqual(CompanyIdentifier.victronEnergyBv.description, "Victron Energy BV")
        ...
        /// Fujitsu Limited
        XCTAssertEqual(CompanyIdentifier.fujitsuLimited.rawValue, 746)
        XCTAssertEqual(CompanyIdentifier.fujitsuLimited.name, "Fujitsu Limited")
        XCTAssertEqual(CompanyIdentifier.fujitsuLimited.description, "Fujitsu Limited")
        ...
        /// HTC Corporation
        XCTAssertEqual(CompanyIdentifier.htcCorporation.rawValue, 749)
        XCTAssertEqual(CompanyIdentifier.htcCorporation.name, "HTC Corporation")
        XCTAssertEqual(CompanyIdentifier.htcCorporation.description, "HTC Corporation")
        ...
        /// Runteq Oy Ltd
        XCTAssertEqual(CompanyIdentifier.runteqOy.rawValue, 760)
        XCTAssertEqual(CompanyIdentifier.runteqOy.name, "Runteq Oy Ltd")
        XCTAssertEqual(CompanyIdentifier.runteqOy.description, "Runteq Oy Ltd")
        ...
        /// Swipp ApS
        XCTAssertEqual(CompanyIdentifier.swippAps.rawValue, 773)
        XCTAssertEqual(CompanyIdentifier.swippAps.name, "Swipp ApS")
        XCTAssertEqual(CompanyIdentifier.swippAps.description, "Swipp ApS")
        ...
        XCTAssertEqual(CompanyIdentifier.fujiIndustrialCoLtd.rawValue, 775)
        XCTAssertEqual(CompanyIdentifier.fujiIndustrialCoLtd.name, "FUJI INDUSTRIAL CO.,LTD.")
        XCTAssertEqual(CompanyIdentifier.fujiIndustrialCoLtd.description, "FUJI INDUSTRIAL CO.,LTD.")
        ...
        XCTAssertEqual(CompanyIdentifier.agMeasurematicsPvt.rawValue, 790)
        XCTAssertEqual(CompanyIdentifier.agMeasurematicsPvt.name, "AG Measurematics Pvt. Ltd.")
        XCTAssertEqual(CompanyIdentifier.agMeasurematicsPvt.description, "AG Measurematics Pvt. Ltd.")
        ...
        /// Enterlab ApS
        XCTAssertEqual(CompanyIdentifier.enterlabAps.rawValue, 797)
        XCTAssertEqual(CompanyIdentifier.enterlabAps.name, "Enterlab ApS")
        XCTAssertEqual(CompanyIdentifier.enterlabAps.description, "Enterlab ApS")
        ...
        /// Compumedics Limited
        XCTAssertEqual(CompanyIdentifier.compumedicsLimited.rawValue, 802)
        XCTAssertEqual(CompanyIdentifier.compumedicsLimited.name, "Compumedics Limited")
        XCTAssertEqual(CompanyIdentifier.compumedicsLimited.description, "Compumedics Limited")
        ...
        /// Corentium AS
        XCTAssertEqual(CompanyIdentifier.corentiumAs.rawValue, 820)
        XCTAssertEqual(CompanyIdentifier.corentiumAs.name, "Corentium AS")
        XCTAssertEqual(CompanyIdentifier.corentiumAs.description, "Corentium AS")
        ...
        XCTAssertEqual(CompanyIdentifier.courtneyThorneLimited.rawValue, 827)
        XCTAssertEqual(CompanyIdentifier.courtneyThorneLimited.name, "Courtney Thorne Limited")
        XCTAssertEqual(CompanyIdentifier.courtneyThorneLimited.description, "Courtney Thorne Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.tpvTechnologyLimited.rawValue, 829)
        XCTAssertEqual(CompanyIdentifier.tpvTechnologyLimited.name, "TPV Technology Limited")
        XCTAssertEqual(CompanyIdentifier.tpvTechnologyLimited.description, "TPV Technology Limited")
        ...
        /// TOPPAN FORMS CO.,LTD.
        XCTAssertEqual(CompanyIdentifier.toppanFormsCoLtd.rawValue, 852)
        XCTAssertEqual(CompanyIdentifier.toppanFormsCoLtd.name, "TOPPAN FORMS CO.,LTD.")
        XCTAssertEqual(CompanyIdentifier.toppanFormsCoLtd.description, "TOPPAN FORMS CO.,LTD.")
        ...
        /// Eaton Corporation
        XCTAssertEqual(CompanyIdentifier.eatonCorporation.rawValue, 860)
        XCTAssertEqual(CompanyIdentifier.eatonCorporation.name, "Eaton Corporation")
        XCTAssertEqual(CompanyIdentifier.eatonCorporation.description, "Eaton Corporation")
        ...
        /// Insulet Corporation
        XCTAssertEqual(CompanyIdentifier.insuletCorporation.rawValue, 864)
        XCTAssertEqual(CompanyIdentifier.insuletCorporation.name, "Insulet Corporation")
        XCTAssertEqual(CompanyIdentifier.insuletCorporation.description, "Insulet Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.faveroElectronicsSrl.rawValue, 868)
        XCTAssertEqual(CompanyIdentifier.faveroElectronicsSrl.name, "Favero Electronics Srl")
        XCTAssertEqual(CompanyIdentifier.faveroElectronicsSrl.description, "Favero Electronics Srl")
        ...
        /// Metormote AB
        XCTAssertEqual(CompanyIdentifier.metormoteAb.rawValue, 872)
        XCTAssertEqual(CompanyIdentifier.metormoteAb.name, "Metormote AB")
        XCTAssertEqual(CompanyIdentifier.metormoteAb.description, "Metormote AB")
        ...
        XCTAssertEqual(CompanyIdentifier.brcontrolsProductsBv.rawValue, 875)
        XCTAssertEqual(CompanyIdentifier.brcontrolsProductsBv.name, "BRControls Products BV")
        XCTAssertEqual(CompanyIdentifier.brcontrolsProductsBv.description, "BRControls Products BV")
        ...
        /// Expain AS
        XCTAssertEqual(CompanyIdentifier.expainAs.rawValue, 885)
        XCTAssertEqual(CompanyIdentifier.expainAs.name, "Expain AS")
        XCTAssertEqual(CompanyIdentifier.expainAs.description, "Expain AS")
        ...
        /// Plejd AB
        XCTAssertEqual(CompanyIdentifier.plejdAb.rawValue, 887)
        XCTAssertEqual(CompanyIdentifier.plejdAb.name, "Plejd AB")
        XCTAssertEqual(CompanyIdentifier.plejdAb.description, "Plejd AB")
        ...
        XCTAssertEqual(CompanyIdentifier.cronologicsCorporation.rawValue, 892)
        XCTAssertEqual(CompanyIdentifier.cronologicsCorporation.name, "Cronologics Corporation")
        XCTAssertEqual(CompanyIdentifier.cronologicsCorporation.description, "Cronologics Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.sharpCorporation.name, "Sharp Corporation")
        XCTAssertEqual(CompanyIdentifier.sharpCorporation.description, "Sharp Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.kapschTrafficcomAb.rawValue, 904)
        XCTAssertEqual(CompanyIdentifier.kapschTrafficcomAb.name, "Kapsch TrafficCom AB")
        XCTAssertEqual(CompanyIdentifier.kapschTrafficcomAb.description, "Kapsch TrafficCom AB")

        /// ActiveBlu Corporation
        XCTAssertEqual(CompanyIdentifier.activebluCorporation.rawValue, 905)
        XCTAssertEqual(CompanyIdentifier.activebluCorporation.name, "ActiveBlu Corporation")
        XCTAssertEqual(CompanyIdentifier.activebluCorporation.description, "ActiveBlu Corporation")

        /// Kohler Mira Limited
        XCTAssertEqual(CompanyIdentifier.kohlerMiraLimited.rawValue, 906)
        XCTAssertEqual(CompanyIdentifier.kohlerMiraLimited.name, "Kohler Mira Limited")
        XCTAssertEqual(CompanyIdentifier.kohlerMiraLimited.description, "Kohler Mira Limited")
        ...
        /// INFOTECH s.r.o.
        XCTAssertEqual(CompanyIdentifier.infotechSRO.rawValue, 912)
        XCTAssertEqual(CompanyIdentifier.infotechSRO.name, "INFOTECH s.r.o.")
        XCTAssertEqual(CompanyIdentifier.infotechSRO.description, "INFOTECH s.r.o.")

        /// Thingsquare AB
        XCTAssertEqual(CompanyIdentifier.thingsquareAb.rawValue, 913)
        XCTAssertEqual(CompanyIdentifier.thingsquareAb.name, "Thingsquare AB")
        XCTAssertEqual(CompanyIdentifier.thingsquareAb.description, "Thingsquare AB")
        ...
        /// Nikon Corporation
        XCTAssertEqual(CompanyIdentifier.nikonCorporation.rawValue, 921)
        XCTAssertEqual(CompanyIdentifier.nikonCorporation.name, "Nikon Corporation")
        XCTAssertEqual(CompanyIdentifier.nikonCorporation.description, "Nikon Corporation")
        ...
        /// SchoolBoard Limited
        XCTAssertEqual(CompanyIdentifier.schoolboardLimited.rawValue, 926)
        XCTAssertEqual(CompanyIdentifier.schoolboardLimited.name, "SchoolBoard Limited")
        XCTAssertEqual(CompanyIdentifier.schoolboardLimited.description, "SchoolBoard Limited")

        /// Molex Corporation
        XCTAssertEqual(CompanyIdentifier.molexCorporation.rawValue, 927)
        XCTAssertEqual(CompanyIdentifier.molexCorporation.name, "Molex Corporation")
        XCTAssertEqual(CompanyIdentifier.molexCorporation.description, "Molex Corporation")

        /// IVT Wireless Limited
        XCTAssertEqual(CompanyIdentifier.ivtWirelessLimited.rawValue, 928)
        XCTAssertEqual(CompanyIdentifier.ivtWirelessLimited.name, "IVT Wireless Limited")
        XCTAssertEqual(CompanyIdentifier.ivtWirelessLimited.description, "IVT Wireless Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.commNSenseCorpDbaVerigo.rawValue, 943)
        XCTAssertEqual(CompanyIdentifier.commNSenseCorpDbaVerigo.name, "Comm-N-Sense Corp DBA Verigo")
        XCTAssertEqual(CompanyIdentifier.commNSenseCorpDbaVerigo.description, "Comm-N-Sense Corp DBA Verigo")
        ...
        XCTAssertEqual(CompanyIdentifier.propagationSystemsLimited.rawValue, 946)
        XCTAssertEqual(CompanyIdentifier.propagationSystemsLimited.name, "Propagation Systems Limited")
        XCTAssertEqual(CompanyIdentifier.propagationSystemsLimited.description, "Propagation Systems Limited")
        ...
        /// Alpha Nodus, inc.
        XCTAssertEqual(CompanyIdentifier.alphaNodusInc.rawValue, 948)
        XCTAssertEqual(CompanyIdentifier.alphaNodusInc.name, "Alpha Nodus, inc.")
        XCTAssertEqual(CompanyIdentifier.alphaNodusInc.description, "Alpha Nodus, inc.")
        ...
        /// A-Safe Limited
        XCTAssertEqual(CompanyIdentifier.aSafeLimited.rawValue, 952)
        XCTAssertEqual(CompanyIdentifier.aSafeLimited.name, "A-Safe Limited")
        XCTAssertEqual(CompanyIdentifier.aSafeLimited.description, "A-Safe Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.maxscendMicroelectronicsCompanyLimited.rawValue, 954)
        XCTAssertEqual(CompanyIdentifier.maxscendMicroelectronicsCompanyLimited.name, "Maxscend Microelectronics Company Limited")
        XCTAssertEqual(CompanyIdentifier.maxscendMicroelectronicsCompanyLimited.description, "Maxscend Microelectronics Company Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.casambiTechnologiesOy.rawValue, 963)
        XCTAssertEqual(CompanyIdentifier.casambiTechnologiesOy.name, "Casambi Technologies Oy")
        XCTAssertEqual(CompanyIdentifier.casambiTechnologiesOy.description, "Casambi Technologies Oy")
        ...
        XCTAssertEqual(CompanyIdentifier.in2ThingsAutomationPvt.rawValue, 970)
        XCTAssertEqual(CompanyIdentifier.in2ThingsAutomationPvt.name, "In2things Automation Pvt. Ltd.")
        XCTAssertEqual(CompanyIdentifier.in2ThingsAutomationPvt.description, "In2things Automation Pvt. Ltd.")

        /// SYSDEV Srl
        XCTAssertEqual(CompanyIdentifier.sysdevSrl.rawValue, 971)
        XCTAssertEqual(CompanyIdentifier.sysdevSrl.name, "SYSDEV Srl")
        XCTAssertEqual(CompanyIdentifier.sysdevSrl.description, "SYSDEV Srl")
        ...
        XCTAssertEqual(CompanyIdentifier.iotPotIndiaPrivateLimited.rawValue, 978)
        XCTAssertEqual(CompanyIdentifier.iotPotIndiaPrivateLimited.name, "IOT Pot India Private Limited")
        XCTAssertEqual(CompanyIdentifier.iotPotIndiaPrivateLimited.description, "IOT Pot India Private Limited")

        /// Sigma Connectivity AB
        XCTAssertEqual(CompanyIdentifier.sigmaConnectivityAb.rawValue, 979)
        XCTAssertEqual(CompanyIdentifier.sigmaConnectivityAb.name, "Sigma Connectivity AB")
        XCTAssertEqual(CompanyIdentifier.sigmaConnectivityAb.description, "Sigma Connectivity AB")
        ...
        XCTAssertEqual(CompanyIdentifier.actionsZhuhaiTechnologyLimited.rawValue, 992)
        XCTAssertEqual(CompanyIdentifier.actionsZhuhaiTechnologyLimited.name, "Actions (Zhuhai) Technology Co., Limited")
        XCTAssertEqual(CompanyIdentifier.actionsZhuhaiTechnologyLimited.description, "Actions (Zhuhai) Technology Co., Limited")
        ...
        /// Sensoan Oy
        XCTAssertEqual(CompanyIdentifier.sensoanOy.rawValue, 994)
        XCTAssertEqual(CompanyIdentifier.sensoanOy.name, "Sensoan Oy")
        XCTAssertEqual(CompanyIdentifier.sensoanOy.description, "Sensoan Oy")
        ...
        /// IoT Instruments Oy
        XCTAssertEqual(CompanyIdentifier.iotInstrumentsOy.rawValue, 998)
        XCTAssertEqual(CompanyIdentifier.iotInstrumentsOy.name, "IoT Instruments Oy")
        XCTAssertEqual(CompanyIdentifier.iotInstrumentsOy.description, "IoT Instruments Oy")
        ...
        /// Flowscape AB
        XCTAssertEqual(CompanyIdentifier.flowscapeAb.rawValue, 1011)
        XCTAssertEqual(CompanyIdentifier.flowscapeAb.name, "Flowscape AB")
        XCTAssertEqual(CompanyIdentifier.flowscapeAb.description, "Flowscape AB")
        ...
        XCTAssertEqual(CompanyIdentifier.searsHoldingsCorporation.rawValue, 1026)
        XCTAssertEqual(CompanyIdentifier.searsHoldingsCorporation.name, "Sears Holdings Corporation")
        XCTAssertEqual(CompanyIdentifier.searsHoldingsCorporation.description, "Sears Holdings Corporation")
        ...
        /// Senix Corporation
        XCTAssertEqual(CompanyIdentifier.senixCorporation.rawValue, 1036)
        XCTAssertEqual(CompanyIdentifier.senixCorporation.name, "Senix Corporation")
        XCTAssertEqual(CompanyIdentifier.senixCorporation.description, "Senix Corporation")
        ...
        /// SKF (U.K.) Limited
        XCTAssertEqual(CompanyIdentifier.skfUKLimited.rawValue, 1038)
        XCTAssertEqual(CompanyIdentifier.skfUKLimited.name, "SKF (U.K.) Limited")
        XCTAssertEqual(CompanyIdentifier.skfUKLimited.description, "SKF (U.K.) Limited")
        ...
        /// Friday Labs Limited
        XCTAssertEqual(CompanyIdentifier.fridayLabsLimited.rawValue, 1050)
        XCTAssertEqual(CompanyIdentifier.fridayLabsLimited.name, "Friday Labs Limited")
        XCTAssertEqual(CompanyIdentifier.fridayLabsLimited.description, "Friday Labs Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.dellComputerCorporation.rawValue, 1054)
        XCTAssertEqual(CompanyIdentifier.dellComputerCorporation.name, "Dell Computer Corporation")
        XCTAssertEqual(CompanyIdentifier.dellComputerCorporation.description, "Dell Computer Corporation")

        /// Kopin Corporation
        XCTAssertEqual(CompanyIdentifier.kopinCorporation.rawValue, 1055)
        XCTAssertEqual(CompanyIdentifier.kopinCorporation.name, "Kopin Corporation")
        XCTAssertEqual(CompanyIdentifier.kopinCorporation.description, "Kopin Corporation")
        ...
        /// Chargifi Limited
        XCTAssertEqual(CompanyIdentifier.chargifiLimited.rawValue, 1059)
        XCTAssertEqual(CompanyIdentifier.chargifiLimited.name, "Chargifi Limited")
        XCTAssertEqual(CompanyIdentifier.chargifiLimited.description, "Chargifi Limited")
        ...
        /// Husqvarna AB
        XCTAssertEqual(CompanyIdentifier.husqvarnaAb.rawValue, 1062)
        XCTAssertEqual(CompanyIdentifier.husqvarnaAb.name, "Husqvarna AB")
        XCTAssertEqual(CompanyIdentifier.husqvarnaAb.description, "Husqvarna AB")
        ...
        /// Meshtech AS
        XCTAssertEqual(CompanyIdentifier.meshtechAs.rawValue, 1069)
        XCTAssertEqual(CompanyIdentifier.meshtechAs.name, "Meshtech AS")
        XCTAssertEqual(CompanyIdentifier.meshtechAs.description, "Meshtech AS")
        ...
        /// Amway Corporation
        XCTAssertEqual(CompanyIdentifier.amwayCorporation.rawValue, 1073)
        XCTAssertEqual(CompanyIdentifier.amwayCorporation.name, "Amway Corporation")
        XCTAssertEqual(CompanyIdentifier.amwayCorporation.description, "Amway Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.draysonTechnologiesEuropeLimited.rawValue, 1078)
        XCTAssertEqual(CompanyIdentifier.draysonTechnologiesEuropeLimited.name, "Drayson Technologies (Europe) Limited")
        XCTAssertEqual(CompanyIdentifier.draysonTechnologiesEuropeLimited.description, "Drayson Technologies (Europe) Limited")
        ...
        /// Nuheara Limited
        XCTAssertEqual(CompanyIdentifier.nuhearaLimited.rawValue, 1082)
        XCTAssertEqual(CompanyIdentifier.nuhearaLimited.name, "Nuheara Limited")
        XCTAssertEqual(CompanyIdentifier.nuhearaLimited.description, "Nuheara Limited")

        /// Appside co., ltd.
        XCTAssertEqual(CompanyIdentifier.appsideCoLtd.rawValue, 1083)
        XCTAssertEqual(CompanyIdentifier.appsideCoLtd.name, "Appside co., ltd.")
        XCTAssertEqual(CompanyIdentifier.appsideCoLtd.description, "Appside co., ltd.")
        ...
        /// Coiler Corporation
        XCTAssertEqual(CompanyIdentifier.coilerCorporation.rawValue, 1085)
        XCTAssertEqual(CompanyIdentifier.coilerCorporation.name, "Coiler Corporation")
        XCTAssertEqual(CompanyIdentifier.coilerCorporation.description, "Coiler Corporation")
        ...
        /// iProtoXi Oy
        XCTAssertEqual(CompanyIdentifier.iprotoxiOy.rawValue, 1089)
        XCTAssertEqual(CompanyIdentifier.iprotoxiOy.name, "iProtoXi Oy")
        XCTAssertEqual(CompanyIdentifier.iprotoxiOy.description, "iProtoXi Oy")
        ...
        /// Metanate Limited
        XCTAssertEqual(CompanyIdentifier.metanateLimited.rawValue, 1092)
        XCTAssertEqual(CompanyIdentifier.metanateLimited.name, "Metanate Limited")
        XCTAssertEqual(CompanyIdentifier.metanateLimited.description, "Metanate Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.teenageEngineeringAb.rawValue, 1104)
        XCTAssertEqual(CompanyIdentifier.teenageEngineeringAb.name, "Teenage Engineering AB")
        XCTAssertEqual(CompanyIdentifier.teenageEngineeringAb.description, "Teenage Engineering AB")

        /// Tunstall Nordic AB
        XCTAssertEqual(CompanyIdentifier.tunstallNordicAb.rawValue, 1105)
        XCTAssertEqual(CompanyIdentifier.tunstallNordicAb.name, "Tunstall Nordic AB")
        XCTAssertEqual(CompanyIdentifier.tunstallNordicAb.description, "Tunstall Nordic AB")

        /// Svep Design Center AB
        XCTAssertEqual(CompanyIdentifier.svepDesignCenterAb.rawValue, 1106)
        XCTAssertEqual(CompanyIdentifier.svepDesignCenterAb.name, "Svep Design Center AB")
        XCTAssertEqual(CompanyIdentifier.svepDesignCenterAb.description, "Svep Design Center AB")

        /// GreenPeak Technologies BV
        XCTAssertEqual(CompanyIdentifier.greenpeakTechnologiesBv.rawValue, 1107)
        XCTAssertEqual(CompanyIdentifier.greenpeakTechnologiesBv.name, "GreenPeak Technologies BV")
        XCTAssertEqual(CompanyIdentifier.greenpeakTechnologiesBv.description, "GreenPeak Technologies BV")

        /// Sphinx Electronics GmbH & Co KG
        XCTAssertEqual(CompanyIdentifier.sphinxElectronicsCoKg.rawValue, 1108)
        XCTAssertEqual(CompanyIdentifier.sphinxElectronicsCoKg.name, "Sphinx Electronics GmbH & Co KG")
        XCTAssertEqual(CompanyIdentifier.sphinxElectronicsCoKg.description, "Sphinx Electronics GmbH & Co KG")
        ...
        /// Delta T Corporation
        XCTAssertEqual(CompanyIdentifier.deltaTCorporation.rawValue, 1116)
        XCTAssertEqual(CompanyIdentifier.deltaTCorporation.name, "Delta T Corporation")
        XCTAssertEqual(CompanyIdentifier.deltaTCorporation.description, "Delta T Corporation")

        /// Boston Scientific Corporation
        XCTAssertEqual(CompanyIdentifier.bostonScientificCorporation.rawValue, 1117)
        XCTAssertEqual(CompanyIdentifier.bostonScientificCorporation.name, "Boston Scientific Corporation")
        XCTAssertEqual(CompanyIdentifier.bostonScientificCorporation.description, "Boston Scientific Corporation")
        ...
        /// Codenex Oy
        XCTAssertEqual(CompanyIdentifier.codenexOy.rawValue, 1127)
        XCTAssertEqual(CompanyIdentifier.codenexOy.name, "Codenex Oy")
        XCTAssertEqual(CompanyIdentifier.codenexOy.description, "Codenex Oy")
        ...
        /// Palago AB
        XCTAssertEqual(CompanyIdentifier.palagoAb.rawValue, 1129)
        XCTAssertEqual(CompanyIdentifier.palagoAb.name, "Palago AB")
        XCTAssertEqual(CompanyIdentifier.palagoAb.description, "Palago AB")
        ...
        /// TiVo Corp
        XCTAssertEqual(CompanyIdentifier.tivoCorp.rawValue, 1137)
        XCTAssertEqual(CompanyIdentifier.tivoCorp.name, "TiVo Corp")
        XCTAssertEqual(CompanyIdentifier.tivoCorp.description, "TiVo Corp")
        ...
        /// iApartment co., ltd.
        XCTAssertEqual(CompanyIdentifier.iapartmentCoLtd.rawValue, 1140)
        XCTAssertEqual(CompanyIdentifier.iapartmentCoLtd.name, "iApartment co., ltd.")
        XCTAssertEqual(CompanyIdentifier.iapartmentCoLtd.description, "iApartment co., ltd.")
        ...
        XCTAssertEqual(CompanyIdentifier.oxstrenWearableTechnologiesPrivateLimited.rawValue, 1142)
        XCTAssertEqual(CompanyIdentifier.oxstrenWearableTechnologiesPrivateLimited.name, "Oxstren Wearable Technologies Private Limited")
        XCTAssertEqual(CompanyIdentifier.oxstrenWearableTechnologiesPrivateLimited.description, "Oxstren Wearable Technologies Private Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.farsiteCommunicationsLimited.rawValue, 1144)
        XCTAssertEqual(CompanyIdentifier.farsiteCommunicationsLimited.name, "FarSite Communications Limited")
        XCTAssertEqual(CompanyIdentifier.farsiteCommunicationsLimited.description, "FarSite Communications Limited")
        ...
        /// Quintrax Limited
        XCTAssertEqual(CompanyIdentifier.quintraxLimited.rawValue, 1153)
        XCTAssertEqual(CompanyIdentifier.quintraxLimited.name, "Quintrax Limited")
        XCTAssertEqual(CompanyIdentifier.quintraxLimited.description, "Quintrax Limited")
        ...
        /// Taelek Oy
        XCTAssertEqual(CompanyIdentifier.taelekOy.rawValue, 1162)
        XCTAssertEqual(CompanyIdentifier.taelekOy.name, "Taelek Oy")
        XCTAssertEqual(CompanyIdentifier.taelekOy.description, "Taelek Oy")

        /// CP Electronics Limited
        XCTAssertEqual(CompanyIdentifier.cpElectronicsLimited.rawValue, 1163)
        XCTAssertEqual(CompanyIdentifier.cpElectronicsLimited.name, "CP Electronics Limited")
        XCTAssertEqual(CompanyIdentifier.cpElectronicsLimited.description, "CP Electronics Limited")
        ...
        /// Matting AB
        XCTAssertEqual(CompanyIdentifier.mattingAb.rawValue, 1168)
        XCTAssertEqual(CompanyIdentifier.mattingAb.name, "Matting AB")
        XCTAssertEqual(CompanyIdentifier.mattingAb.description, "Matting AB")
        ...
        /// Cochlear Limited
        XCTAssertEqual(CompanyIdentifier.cochlearLimited.rawValue, 1175)
        XCTAssertEqual(CompanyIdentifier.cochlearLimited.name, "Cochlear Limited")
        XCTAssertEqual(CompanyIdentifier.cochlearLimited.description, "Cochlear Limited")
        ...
        /// Situne AS
        XCTAssertEqual(CompanyIdentifier.situneAs.rawValue, 1178)
        XCTAssertEqual(CompanyIdentifier.situneAs.name, "Situne AS")
        XCTAssertEqual(CompanyIdentifier.situneAs.description, "Situne AS")
        ...
        /// tictote AB
        XCTAssertEqual(CompanyIdentifier.tictoteAb.rawValue, 1183)
        XCTAssertEqual(CompanyIdentifier.tictoteAb.name, "tictote AB")
        XCTAssertEqual(CompanyIdentifier.tictoteAb.description, "tictote AB")
        ...
        XCTAssertEqual(CompanyIdentifier.pniSensorCorporation.rawValue, 1185)
        XCTAssertEqual(CompanyIdentifier.pniSensorCorporation.name, "PNI Sensor Corporation")
        XCTAssertEqual(CompanyIdentifier.pniSensorCorporation.description, "PNI Sensor Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.dallasLogicCorporation.rawValue, 1191)
        XCTAssertEqual(CompanyIdentifier.dallasLogicCorporation.name, "Dallas Logic Corporation")
        XCTAssertEqual(CompanyIdentifier.dallasLogicCorporation.description, "Dallas Logic Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.kartographersTechnologiesPvt.rawValue, 1201)
        XCTAssertEqual(CompanyIdentifier.kartographersTechnologiesPvt.name, "Kartographers Technologies Pvt. Ltd.")
        XCTAssertEqual(CompanyIdentifier.kartographersTechnologiesPvt.description, "Kartographers Technologies Pvt. Ltd.")
        ...
        XCTAssertEqual(CompanyIdentifier.mobikeHongKongLimited.rawValue, 1203)
        XCTAssertEqual(CompanyIdentifier.mobikeHongKongLimited.name, "mobike (Hong Kong) Limited")
        XCTAssertEqual(CompanyIdentifier.mobikeHongKongLimited.description, "mobike (Hong Kong) Limited")

        /// Inuheat Group AB
        XCTAssertEqual(CompanyIdentifier.inuheatGroupAb.rawValue, 1204)
        XCTAssertEqual(CompanyIdentifier.inuheatGroupAb.name, "Inuheat Group AB")
        XCTAssertEqual(CompanyIdentifier.inuheatGroupAb.description, "Inuheat Group AB")

        /// Swiftronix AB
        XCTAssertEqual(CompanyIdentifier.swiftronixAb.rawValue, 1205)
        XCTAssertEqual(CompanyIdentifier.swiftronixAb.name, "Swiftronix AB")
        XCTAssertEqual(CompanyIdentifier.swiftronixAb.description, "Swiftronix AB")
        ...
        XCTAssertEqual(CompanyIdentifier.csrBuildingProductsLimited.rawValue, 1209)
        XCTAssertEqual(CompanyIdentifier.csrBuildingProductsLimited.name, "CSR Building Products Limited")
        XCTAssertEqual(CompanyIdentifier.csrBuildingProductsLimited.description, "CSR Building Products Limited")
        ...
        /// Sospitas, s.r.o.
        XCTAssertEqual(CompanyIdentifier.sospitasSRO.rawValue, 1217)
        XCTAssertEqual(CompanyIdentifier.sospitasSRO.name, "Sospitas, s.r.o.")
        XCTAssertEqual(CompanyIdentifier.sospitasSRO.description, "Sospitas, s.r.o.")
        ...
        XCTAssertEqual(CompanyIdentifier.mantracourtElectronicsLimited.rawValue, 1219)
        XCTAssertEqual(CompanyIdentifier.mantracourtElectronicsLimited.name, "Mantracourt Electronics Limited")
        XCTAssertEqual(CompanyIdentifier.mantracourtElectronicsLimited.description, "Mantracourt Electronics Limited")

        /// TeAM Hutchins AB
        XCTAssertEqual(CompanyIdentifier.teamHutchinsAb.rawValue, 1220)
        XCTAssertEqual(CompanyIdentifier.teamHutchinsAb.name, "TeAM Hutchins AB")
        XCTAssertEqual(CompanyIdentifier.teamHutchinsAb.description, "TeAM Hutchins AB")
        ...
        /// Olympus Corporation
        XCTAssertEqual(CompanyIdentifier.olympusCorporation.rawValue, 1232)
        XCTAssertEqual(CompanyIdentifier.olympusCorporation.name, "Olympus Corporation")
        XCTAssertEqual(CompanyIdentifier.olympusCorporation.description, "Olympus Corporation")
        ...
        /// Gooee Limited
        XCTAssertEqual(CompanyIdentifier.gooeeLimited.rawValue, 1237)
        XCTAssertEqual(CompanyIdentifier.gooeeLimited.name, "Gooee Limited")
        XCTAssertEqual(CompanyIdentifier.gooeeLimited.description, "Gooee Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.fujifilmCorporation.rawValue, 1240)
        XCTAssertEqual(CompanyIdentifier.fujifilmCorporation.name, "FUJIFILM Corporation")
        XCTAssertEqual(CompanyIdentifier.fujifilmCorporation.description, "FUJIFILM Corporation")
        ...
        /// Avack Oy
        XCTAssertEqual(CompanyIdentifier.avackOy.rawValue, 1253)
        XCTAssertEqual(CompanyIdentifier.avackOy.name, "Avack Oy")
        XCTAssertEqual(CompanyIdentifier.avackOy.description, "Avack Oy")
        ...
        /// Kosi Limited
        XCTAssertEqual(CompanyIdentifier.kosiLimited.rawValue, 1264)
        XCTAssertEqual(CompanyIdentifier.kosiLimited.name, "Kosi Limited")
        XCTAssertEqual(CompanyIdentifier.kosiLimited.description, "Kosi Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.indreamerTechsolPrivateLimited.rawValue, 1266)
        XCTAssertEqual(CompanyIdentifier.indreamerTechsolPrivateLimited.name, "InDreamer Techsol Private Limited")
        XCTAssertEqual(CompanyIdentifier.indreamerTechsolPrivateLimited.description, "InDreamer Techsol Private Limited")
        ...
        /// McLear Limited
        XCTAssertEqual(CompanyIdentifier.mclearLimited.rawValue, 1270)
        XCTAssertEqual(CompanyIdentifier.mclearLimited.name, "McLear Limited")
        XCTAssertEqual(CompanyIdentifier.mclearLimited.description, "McLear Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.convergenceSystemsLimited.rawValue, 1272)
        XCTAssertEqual(CompanyIdentifier.convergenceSystemsLimited.name, "Convergence Systems Limited")
        XCTAssertEqual(CompanyIdentifier.convergenceSystemsLimited.description, "Convergence Systems Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.microsemiCorporation.rawValue, 1279)
        XCTAssertEqual(CompanyIdentifier.microsemiCorporation.name, "Microsemi Corporation")
        XCTAssertEqual(CompanyIdentifier.microsemiCorporation.description, "Microsemi Corporation")
        ...
        /// Amcore AB
        XCTAssertEqual(CompanyIdentifier.amcoreAb.rawValue, 1303)
        XCTAssertEqual(CompanyIdentifier.amcoreAb.name, "Amcore AB")
        XCTAssertEqual(CompanyIdentifier.amcoreAb.description, "Amcore AB")
        ...
        /// Detect Blue Limited
        XCTAssertEqual(CompanyIdentifier.detectBlueLimited.rawValue, 1310)
        XCTAssertEqual(CompanyIdentifier.detectBlueLimited.name, "Detect Blue Limited")
        XCTAssertEqual(CompanyIdentifier.detectBlueLimited.description, "Detect Blue Limited")
        ...
        /// Target Corporation
        XCTAssertEqual(CompanyIdentifier.targetCorporation.rawValue, 1312)
        XCTAssertEqual(CompanyIdentifier.targetCorporation.name, "Target Corporation")
        XCTAssertEqual(CompanyIdentifier.targetCorporation.description, "Target Corporation")

        /// IAI Corporation
        XCTAssertEqual(CompanyIdentifier.iaiCorporation.rawValue, 1313)
        XCTAssertEqual(CompanyIdentifier.iaiCorporation.name, "IAI Corporation")
        XCTAssertEqual(CompanyIdentifier.iaiCorporation.description, "IAI Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.smartComponentTechnologiesLimited.rawValue, 1333)
        XCTAssertEqual(CompanyIdentifier.smartComponentTechnologiesLimited.name, "Smart Component Technologies Limited")
        XCTAssertEqual(CompanyIdentifier.smartComponentTechnologiesLimited.description, "Smart Component Technologies Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.metalogicsCorporation.rawValue, 1335)
        XCTAssertEqual(CompanyIdentifier.metalogicsCorporation.name, "MetaLogics Corporation")
        XCTAssertEqual(CompanyIdentifier.metalogicsCorporation.description, "MetaLogics Corporation")
        ...
        /// Silergy Corp
        XCTAssertEqual(CompanyIdentifier.silergyCorp.rawValue, 1343)
        XCTAssertEqual(CompanyIdentifier.silergyCorp.name, "Silergy Corp")
        XCTAssertEqual(CompanyIdentifier.silergyCorp.description, "Silergy Corp")
        ...
        XCTAssertEqual(CompanyIdentifier.smartTechnologiesAndInvestmentLimited.rawValue, 1353)
        XCTAssertEqual(CompanyIdentifier.smartTechnologiesAndInvestmentLimited.name, "Smart Technologies and Investment Limited")
        XCTAssertEqual(CompanyIdentifier.smartTechnologiesAndInvestmentLimited.description, "Smart Technologies and Investment Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.arwinTechnologyLimited.rawValue, 1367)
        XCTAssertEqual(CompanyIdentifier.arwinTechnologyLimited.name, "Arwin Technology Limited")
        XCTAssertEqual(CompanyIdentifier.arwinTechnologyLimited.description, "Arwin Technology Limited")

        /// benegear, inc.
        XCTAssertEqual(CompanyIdentifier.benegearInc.rawValue, 1368)
        XCTAssertEqual(CompanyIdentifier.benegearInc.name, "benegear, inc.")
        XCTAssertEqual(CompanyIdentifier.benegearInc.description, "benegear, inc.")
        ...
        /// Valve Corporation
        XCTAssertEqual(CompanyIdentifier.valveCorporation.rawValue, 1373)
        XCTAssertEqual(CompanyIdentifier.valveCorporation.name, "Valve Corporation")
        XCTAssertEqual(CompanyIdentifier.valveCorporation.description, "Valve Corporation")
        ...
        /// BikeFinder AS
        XCTAssertEqual(CompanyIdentifier.bikefinderAs.rawValue, 1391)
        XCTAssertEqual(CompanyIdentifier.bikefinderAs.name, "BikeFinder AS")
        XCTAssertEqual(CompanyIdentifier.bikefinderAs.description, "BikeFinder AS")
        ...
        XCTAssertEqual(CompanyIdentifier.ensembleTechPrivateLimited.rawValue, 1401)
        XCTAssertEqual(CompanyIdentifier.ensembleTechPrivateLimited.name, "Ensemble Tech Private Limited")
        XCTAssertEqual(CompanyIdentifier.ensembleTechPrivateLimited.description, "Ensemble Tech Private Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.aranzMedicalLimited.rawValue, 1408)
        XCTAssertEqual(CompanyIdentifier.aranzMedicalLimited.name, "ARANZ Medical Limited")
        XCTAssertEqual(CompanyIdentifier.aranzMedicalLimited.description, "ARANZ Medical Limited")
        ...
        /// START TODAY CO.,LTD.
        XCTAssertEqual(CompanyIdentifier.startTodayCoLtd.rawValue, 1418)
        XCTAssertEqual(CompanyIdentifier.startTodayCoLtd.name, "START TODAY CO.,LTD.")
        XCTAssertEqual(CompanyIdentifier.startTodayCoLtd.description, "START TODAY CO.,LTD.")
        ...
        /// Inor Process AB
        XCTAssertEqual(CompanyIdentifier.inorProcessAb.rawValue, 1429)
        XCTAssertEqual(CompanyIdentifier.inorProcessAb.name, "Inor Process AB")
        XCTAssertEqual(CompanyIdentifier.inorProcessAb.description, "Inor Process AB")
        ...
        XCTAssertEqual(CompanyIdentifier.dataflowSystemsLimited.rawValue, 1435)
        XCTAssertEqual(CompanyIdentifier.dataflowSystemsLimited.name, "Dataflow Systems Limited")
        XCTAssertEqual(CompanyIdentifier.dataflowSystemsLimited.description, "Dataflow Systems Limited")
        ...
        /// RCP Software Oy
        XCTAssertEqual(CompanyIdentifier.rcpSoftwareOy.rawValue, 1440)
        XCTAssertEqual(CompanyIdentifier.rcpSoftwareOy.name, "RCP Software Oy")
        XCTAssertEqual(CompanyIdentifier.rcpSoftwareOy.description, "RCP Software Oy")
        ...
        /// Kiiroo BV
        XCTAssertEqual(CompanyIdentifier.kiirooBv.rawValue, 1445)
        XCTAssertEqual(CompanyIdentifier.kiirooBv.name, "Kiiroo BV")
        XCTAssertEqual(CompanyIdentifier.kiirooBv.description, "Kiiroo BV")

        /// Telecon Mobile Limited
        XCTAssertEqual(CompanyIdentifier.teleconMobileLimited.rawValue, 1446)
        XCTAssertEqual(CompanyIdentifier.teleconMobileLimited.name, "Telecon Mobile Limited")
        XCTAssertEqual(CompanyIdentifier.teleconMobileLimited.description, "Telecon Mobile Limited")
        ...
        /// Tramex Limited
        XCTAssertEqual(CompanyIdentifier.tramexLimited.rawValue, 1450)
        XCTAssertEqual(CompanyIdentifier.tramexLimited.name, "Tramex Limited")
        XCTAssertEqual(CompanyIdentifier.tramexLimited.description, "Tramex Limited")

        /// Nofence AS
        XCTAssertEqual(CompanyIdentifier.nofenceAs.rawValue, 1451)
        XCTAssertEqual(CompanyIdentifier.nofenceAs.name, "Nofence AS")
        XCTAssertEqual(CompanyIdentifier.nofenceAs.description, "Nofence AS")
        ...
        XCTAssertEqual(CompanyIdentifier.whiteHorseScientificLtd.rawValue, 1460)
        XCTAssertEqual(CompanyIdentifier.whiteHorseScientificLtd.name, "White Horse Scientific ltd")
        XCTAssertEqual(CompanyIdentifier.whiteHorseScientificLtd.description, "White Horse Scientific ltd")
        ...
        XCTAssertEqual(CompanyIdentifier.realWorldSystemsCorporation.rawValue, 1471)
        XCTAssertEqual(CompanyIdentifier.realWorldSystemsCorporation.name, "Real-World-Systems Corporation")
        XCTAssertEqual(CompanyIdentifier.realWorldSystemsCorporation.description, "Real-World-Systems Corporation")
        ...
        /// Lindab AB
        XCTAssertEqual(CompanyIdentifier.lindabAb.rawValue, 1489)
        XCTAssertEqual(CompanyIdentifier.lindabAb.name, "Lindab AB")
        XCTAssertEqual(CompanyIdentifier.lindabAb.description, "Lindab AB")
        ...
        /// Acurable Limited
        XCTAssertEqual(CompanyIdentifier.acurableLimited.rawValue, 1491)
        XCTAssertEqual(CompanyIdentifier.acurableLimited.name, "Acurable Limited")
        XCTAssertEqual(CompanyIdentifier.acurableLimited.description, "Acurable Limited")
        ...
        XCTAssertEqual(CompanyIdentifier.toyoElectronicsCorporation.rawValue, 1497)
        XCTAssertEqual(CompanyIdentifier.toyoElectronicsCorporation.name, "Toyo Electronics Corporation")
        XCTAssertEqual(CompanyIdentifier.toyoElectronicsCorporation.description, "Toyo Electronics Corporation")

        /// Applied Neural Research Corp
        XCTAssertEqual(CompanyIdentifier.appliedNeuralResearchCorp.rawValue, 1498)
        XCTAssertEqual(CompanyIdentifier.appliedNeuralResearchCorp.name, "Applied Neural Research Corp")
        XCTAssertEqual(CompanyIdentifier.appliedNeuralResearchCorp.description, "Applied Neural Research Corp")
        ...
        /// Gycom Svenska AB
        XCTAssertEqual(CompanyIdentifier.gycomSvenskaAb.rawValue, 1516)
        XCTAssertEqual(CompanyIdentifier.gycomSvenskaAb.name, "Gycom Svenska AB")
        XCTAssertEqual(CompanyIdentifier.gycomSvenskaAb.description, "Gycom Svenska AB")
        ...
        /// SIKOM AS
        XCTAssertEqual(CompanyIdentifier.sikomAs.rawValue, 1519)
        XCTAssertEqual(CompanyIdentifier.sikomAs.name, "SIKOM AS")
        XCTAssertEqual(CompanyIdentifier.sikomAs.description, "SIKOM AS")
        ...
        /// Try and E CO.,LTD.
        XCTAssertEqual(CompanyIdentifier.tryAndECoLtd.rawValue, 1522)
        XCTAssertEqual(CompanyIdentifier.tryAndECoLtd.name, "Try and E CO.,LTD.")
        XCTAssertEqual(CompanyIdentifier.tryAndECoLtd.description, "Try and E CO.,LTD.")
        ...
        /// iRobot Corporation
        XCTAssertEqual(CompanyIdentifier.irobotCorporation.rawValue, 1536)
        XCTAssertEqual(CompanyIdentifier.irobotCorporation.name, "iRobot Corporation")
        XCTAssertEqual(CompanyIdentifier.irobotCorporation.description, "iRobot Corporation")
        ...
        /// Vuzix Corporation
        XCTAssertEqual(CompanyIdentifier.vuzixCorporation.rawValue, 1548)
        XCTAssertEqual(CompanyIdentifier.vuzixCorporation.name, "Vuzix Corporation")
        XCTAssertEqual(CompanyIdentifier.vuzixCorporation.description, "Vuzix Corporation")

        /// TDK Corporation
        XCTAssertEqual(CompanyIdentifier.tdkCorporation.rawValue, 1549)
        XCTAssertEqual(CompanyIdentifier.tdkCorporation.name, "TDK Corporation")
        XCTAssertEqual(CompanyIdentifier.tdkCorporation.description, "TDK Corporation")

        /// Blueair AB
        XCTAssertEqual(CompanyIdentifier.blueairAb.rawValue, 1550)
        XCTAssertEqual(CompanyIdentifier.blueairAb.name, "Blueair AB")
        XCTAssertEqual(CompanyIdentifier.blueairAb.description, "Blueair AB")
        ...
        /// Playfinity AS
        XCTAssertEqual(CompanyIdentifier.playfinityAs.rawValue, 1554)
        XCTAssertEqual(CompanyIdentifier.playfinityAs.name, "Playfinity AS")
        XCTAssertEqual(CompanyIdentifier.playfinityAs.description, "Playfinity AS")
        ...
        XCTAssertEqual(CompanyIdentifier.interActionCorporation.rawValue, 1557)
        XCTAssertEqual(CompanyIdentifier.interActionCorporation.name, "INTER ACTION Corporation")
        XCTAssertEqual(CompanyIdentifier.interActionCorporation.description, "INTER ACTION Corporation")
        ...
        XCTAssertEqual(CompanyIdentifier.audioTechnicaCorporation.rawValue, 1560)
        XCTAssertEqual(CompanyIdentifier.audioTechnicaCorporation.name, "Audio-Technica Corporation")
        XCTAssertEqual(CompanyIdentifier.audioTechnicaCorporation.description, "Audio-Technica Corporation")

        /// Six Guys Labs, s.r.o.
        XCTAssertEqual(CompanyIdentifier.sixGuysLabsSRO.rawValue, 1561)
        XCTAssertEqual(CompanyIdentifier.sixGuysLabsSRO.name, "Six Guys Labs, s.r.o.")
        XCTAssertEqual(CompanyIdentifier.sixGuysLabsSRO.description, "Six Guys Labs, s.r.o.")

        /// R.W. Beckett Corporation
        XCTAssertEqual(CompanyIdentifier.rWBeckettCorporation.rawValue, 1562)
        XCTAssertEqual(CompanyIdentifier.rWBeckettCorporation.name, "R.W. Beckett Corporation")
        XCTAssertEqual(CompanyIdentifier.rWBeckettCorporation.description, "R.W. Beckett Corporation")

        /// silex technology, inc.
        XCTAssertEqual(CompanyIdentifier.silexTechnologyInc.rawValue, 1563)
        XCTAssertEqual(CompanyIdentifier.silexTechnologyInc.name, "silex technology, inc.")
        XCTAssertEqual(CompanyIdentifier.silexTechnologyInc.description, "silex technology, inc.")

        /// Univations Limited
        XCTAssertEqual(CompanyIdentifier.univationsLimited.rawValue, 1564)
        XCTAssertEqual(CompanyIdentifier.univationsLimited.name, "Univations Limited")
        XCTAssertEqual(CompanyIdentifier.univationsLimited.description, "Univations Limited")

        /// SENS Innovation ApS
        XCTAssertEqual(CompanyIdentifier.sensInnovationAps.rawValue, 1565)
        XCTAssertEqual(CompanyIdentifier.sensInnovationAps.name, "SENS Innovation ApS")
        XCTAssertEqual(CompanyIdentifier.sensInnovationAps.description, "SENS Innovation ApS")
        ...
        /// Forciot Oy
        XCTAssertEqual(CompanyIdentifier.forciotOy.rawValue, 1568)
        XCTAssertEqual(CompanyIdentifier.forciotOy.name, "Forciot Oy")
        XCTAssertEqual(CompanyIdentifier.forciotOy.description, "Forciot Oy")
        ...
        XCTAssertEqual(CompanyIdentifier.philadelphiaScientificUKLimited.rawValue, 1571)
        XCTAssertEqual(CompanyIdentifier.philadelphiaScientificUKLimited.name, "Philadelphia Scientific (U.K.) Limited")
        XCTAssertEqual(CompanyIdentifier.philadelphiaScientificUKLimited.description, "Philadelphia Scientific (U.K.) Limited")
        ...
        /// Ensto Oy
        XCTAssertEqual(CompanyIdentifier.enstoOy.rawValue, 1576)
        XCTAssertEqual(CompanyIdentifier.enstoOy.name, "Ensto Oy")
        XCTAssertEqual(CompanyIdentifier.enstoOy.description, "Ensto Oy")
        ...
        /// ONKYO Corporation
        XCTAssertEqual(CompanyIdentifier.onkyoCorporation.rawValue, 1583)
        XCTAssertEqual(CompanyIdentifier.onkyoCorporation.name, "ONKYO Corporation")
        XCTAssertEqual(CompanyIdentifier.onkyoCorporation.description, "ONKYO Corporation")

        /// Asthrea D.O.O.
        XCTAssertEqual(CompanyIdentifier.asthreaDOO.rawValue, 1584)
        XCTAssertEqual(CompanyIdentifier.asthreaDOO.name, "Asthrea D.O.O.")
        XCTAssertEqual(CompanyIdentifier.asthreaDOO.description, "Asthrea D.O.O.")
        ...
        XCTAssertEqual(CompanyIdentifier.hugoMullerCoKg.rawValue, 1586)
        XCTAssertEqual(CompanyIdentifier.hugoMullerCoKg.name, "Hugo Muller GmbH & Co KG")
        XCTAssertEqual(CompanyIdentifier.hugoMullerCoKg.description, "Hugo Muller GmbH & Co KG")
        ...
        /// Fanstel Corp
        XCTAssertEqual(CompanyIdentifier.fanstelCorp.rawValue, 1588)
        XCTAssertEqual(CompanyIdentifier.fanstelCorp.name, "Fanstel Corp")
        XCTAssertEqual(CompanyIdentifier.fanstelCorp.description, "Fanstel Corp")
        ...
        /// Prolojik Limited
        XCTAssertEqual(CompanyIdentifier.prolojikLimited.rawValue, 1594)
        XCTAssertEqual(CompanyIdentifier.prolojikLimited.name, "Prolojik Limited")
        XCTAssertEqual(CompanyIdentifier.prolojikLimited.description, "Prolojik Limited")
