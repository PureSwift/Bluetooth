...
final class HCITests: XCTestCase {
    ...
    func testInquiryResult() {
        ...
        do {
            ...
            let buffer: [UInt8] = [0x2F, 0xFF, 0x01, 0xED, 0xF4, 0x1D, 0x67, 0xB1, 0x04, 0x01, 0x00, 0x0C, 0x02, 0x5A, 0x52, 0x1E, 0xB8]
            
            guard let event = HCIInquiryResult(data: Data(buffer))
                else { XCTFail("Could not parse"); return }
