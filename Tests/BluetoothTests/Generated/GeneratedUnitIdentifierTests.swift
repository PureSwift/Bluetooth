...
final class UnitIdentifierTests: XCTestCase {
    ...
    func testUnits() {
        ...
        XCTAssertEqual(UnitIdentifier.unitless.description, #"0x2700 (unitless)"#)
        ...
        XCTAssertEqual(UnitIdentifier.metre.description, #"0x2701 (length (metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.kilogram.description, #"0x2702 (mass (kilogram))"#)
        ...
        XCTAssertEqual(UnitIdentifier.second.description, #"0x2703 (time (second))"#)
        ...
        XCTAssertEqual(UnitIdentifier.ampere.description, #"0x2704 (electric current (ampere))"#)
        ...
        XCTAssertEqual(UnitIdentifier.kelvin.description, #"0x2705 (thermodynamic temperature (kelvin))"#)
        ...
        XCTAssertEqual(UnitIdentifier.mole.description, #"0x2706 (amount of substance (mole))"#)
        ...
        XCTAssertEqual(UnitIdentifier.candela.description, #"0x2707 (luminous intensity (candela))"#)
        ...
        XCTAssertEqual(UnitIdentifier.area.description, #"0x2710 (area (square metres))"#)
        ...
        XCTAssertEqual(UnitIdentifier.volume.description, #"0x2711 (volume (cubic metres))"#)
        ...
        XCTAssertEqual(UnitIdentifier.velocity.description, #"0x2712 (velocity (metres per second))"#)
        ...
        XCTAssertEqual(UnitIdentifier.acceleration.description, #"0x2713 (acceleration (metres per second squared))"#)
        ...
        XCTAssertEqual(UnitIdentifier.wavenumber.description, #"0x2714 (wavenumber (reciprocal metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.density.description, #"0x2715 (density (kilogram per cubic metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.surfaceDensity.description, #"0x2716 (surface density (kilogram per square metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.specificVolume.description, #"0x2717 (specific volume (cubic metre per kilogram))"#)
        ...
        XCTAssertEqual(UnitIdentifier.currentDensity.description, #"0x2718 (current density (ampere per square metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.magneticFieldStrengh.description, #"0x2719 (magnetic field strength (ampere per metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.amountConcentration.description, #"0x271A (amount concentration (mole per cubic metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.massConcentration.description, #"0x271B (mass concentration (kilogram per cubic metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.luminance.description, #"0x271C (luminance (candela per square metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.refractiveIndex.description, #"0x271D (refractive index)"#)
        ...
        XCTAssertEqual(UnitIdentifier.relativePermeability.description, #"0x271E (relative permeability)"#)
        ...
        XCTAssertEqual(UnitIdentifier.planeAngle.description, #"0x2720 (plane angle (radian))"#)
        ...
        XCTAssertEqual(UnitIdentifier.solidAngle.description, #"0x2721 (solid angle (steradian))"#)
        ...
        XCTAssertEqual(UnitIdentifier.frequency.description, #"0x2722 (frequency (hertz))"#)
        ...
        XCTAssertEqual(UnitIdentifier.force.description, #"0x2723 (force (newton))"#)
        ...
        XCTAssertEqual(UnitIdentifier.pascalPressure.description, #"0x2724 (pressure (pascal))"#)
        ...
        XCTAssertEqual(UnitIdentifier.energy.description, #"0x2725 (energy (joule))"#)
        ...
        XCTAssertEqual(UnitIdentifier.power.description, #"0x2726 (power (watt))"#)
        ...
        XCTAssertEqual(UnitIdentifier.coulomb.description, #"0x2727 (electric charge (coulomb))"#)
        ...
        XCTAssertEqual(UnitIdentifier.electricPotential.description, #"0x2728 (electric potential difference (volt))"#)
        ...
        XCTAssertEqual(UnitIdentifier.capitance.description, #"0x2729 (capacitance (farad))"#)
        ...
        XCTAssertEqual(UnitIdentifier.electricResistance.description, #"0x272A (electric resistance (ohm))"#)
        ...
        XCTAssertEqual(UnitIdentifier.electricConductance.description, #"0x272B (electric conductance (siemens))"#)
        ...
        XCTAssertEqual(UnitIdentifier.magneticFlux.description, #"0x272C (magnetic flux (weber))"#)
        ...
        XCTAssertEqual(UnitIdentifier.magneticFluxDensity.description, #"0x272D (magnetic flux density (tesla))"#)
        ...
        XCTAssertEqual(UnitIdentifier.inductance.description, #"0x272E (inductance (henry))"#)
        ...
        XCTAssertEqual(UnitIdentifier.celsius.description, #"0x272F (Celsius temperature (degree Celsius))"#)
        ...
        XCTAssertEqual(UnitIdentifier.luminousFlux.description, #"0x2730 (luminous flux (lumen))"#)
        ...
        XCTAssertEqual(UnitIdentifier.illuminance.description, #"0x2731 (illuminance (lux))"#)
        ...
        XCTAssertEqual(UnitIdentifier.becquerel.description, #"0x2732 (activity referred to a radionuclide (becquerel))"#)
        ...
        XCTAssertEqual(UnitIdentifier.absorbedDose.description, #"0x2733 (absorbed dose (gray))"#)
        ...
        XCTAssertEqual(UnitIdentifier.sievert.description, #"0x2734 (dose equivalent (sievert))"#)
        ...
        XCTAssertEqual(UnitIdentifier.katal.description, #"0x2735 (catalytic activity (katal))"#)
        ...
        XCTAssertEqual(UnitIdentifier.pascalSecond.description, #"0x2740 (dynamic viscosity (pascal second))"#)
        ...
        XCTAssertEqual(UnitIdentifier.newtonMetre.description, #"0x2741 (moment of force (newton metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.surfaceTension.description, #"0x2742 (surface tension (newton per metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.angularVelocity.description, #"0x2743 (angular velocity (radian per second))"#)
        ...
        XCTAssertEqual(UnitIdentifier.angularAcceleration.description, #"0x2744 (angular acceleration (radian per second squared))"#)
        ...
        XCTAssertEqual(UnitIdentifier.heatFluxDensity.description, #"0x2745 (heat flux density (watt per square metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.heatCapacity.description, #"0x2746 (heat capacity (joule per kelvin))"#)
        ...
        XCTAssertEqual(UnitIdentifier.specificHeatCapacity.description, #"0x2747 (specific heat capacity (joule per kilogram kelvin))"#)
        ...
        XCTAssertEqual(UnitIdentifier.specificEnergy.description, #"0x2748 (specific energy (joule per kilogram))"#)
        ...
        XCTAssertEqual(UnitIdentifier.thermalConductivity.description, #"0x2749 (thermal conductivity (watt per metre kelvin))"#)
        ...
        XCTAssertEqual(UnitIdentifier.energyDensity.description, #"0x274A (energy density (joule per cubic metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.electricFieldStrength.description, #"0x274B (electric field strength (volt per metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.electricChargeDensity.description, #"0x274C (electric charge density (coulomb per cubic metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.surfaceChargeDensity.description, #"0x274D (surface charge density (coulomb per square metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.electricFluxDensity.description, #"0x274E (electric flux density (coulomb per square metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.permittivity.description, #"0x274F (permittivity (farad per metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.permeability.description, #"0x2750 (permeability (henry per metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.molarEnergy.description, #"0x2751 (molar energy (joule per mole))"#)
        ...
        XCTAssertEqual(UnitIdentifier.molarEntropy.description, #"0x2752 (molar entropy (joule per mole kelvin))"#)
        ...
        XCTAssertEqual(UnitIdentifier.exposure.description, #"0x2753 (exposure (coulomb per kilogram))"#)
        ...
        XCTAssertEqual(UnitIdentifier.absorbedDoseRate.description, #"0x2754 (absorbed dose rate (gray per second))"#)
        ...
        XCTAssertEqual(UnitIdentifier.radradiantIntensityiance.description, #"0x2755 (radiant intensity (watt per steradian))"#)
        ...
        XCTAssertEqual(UnitIdentifier.radiance.description, #"0x2756 (radiance (watt per square metre steradian))"#)
        ...
        XCTAssertEqual(UnitIdentifier.catalyticActivity.description, #"0x2757 (catalytic activity concentration (katal per cubic metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.minute.description, #"0x2760 (time (minute))"#)
        ...
        XCTAssertEqual(UnitIdentifier.hour.description, #"0x2761 (time (hour))"#)
        ...
        XCTAssertEqual(UnitIdentifier.day.description, #"0x2762 (time (day))"#)
        ...
        XCTAssertEqual(UnitIdentifier.degree.description, #"0x2763 (plane angle (degree))"#)
        ...
        XCTAssertEqual(UnitIdentifier.planeAngleMinute.description, #"0x2764 (plane angle (minute))"#)
        ...
        XCTAssertEqual(UnitIdentifier.planeAngleSecond.description, #"0x2765 (plane angle (second))"#)
        ...
        XCTAssertEqual(UnitIdentifier.litre.description, #"0x2767 (volume (litre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.tonne.description, #"0x2768 (mass (tonne))"#)
        ...
        XCTAssertEqual(UnitIdentifier.bar.description, #"0x2780 (pressure (bar))"#)
        ...
        XCTAssertEqual(UnitIdentifier.millimetreOfMercury.description, #"0x2781 (pressure (millimetre of mercury))"#)
    
        // length (ångström)
        XCTAssertEqual(UnitIdentifier.ngstrm.rawValue, 0x2782)
        XCTAssertEqual(UnitIdentifier.ngstrm.type, #"org.bluetooth.unit.length.ångström"#)
        XCTAssertEqual(UnitIdentifier.ngstrm.name, #"length (ångström)"#)
        XCTAssertEqual(UnitIdentifier.ngstrm.description, #"0x2782 (length (ångström))"#)
        ...
        XCTAssertEqual(UnitIdentifier.nauticalMile.description, #"0x2783 (length (nautical mile))"#)
        ...
        XCTAssertEqual(UnitIdentifier.barn.description, #"0x2784 (area (barn))"#)
        ...
        XCTAssertEqual(UnitIdentifier.velocityKnot.description, #"0x2785 (velocity (knot))"#)
        ...
        XCTAssertEqual(UnitIdentifier.neper.description, #"0x2786 (logarithmic radio quantity (neper))"#)
        ...
        XCTAssertEqual(UnitIdentifier.bel.description, #"0x2787 (logarithmic radio quantity (bel))"#)
        ...
        XCTAssertEqual(UnitIdentifier.yard.description, #"0x27A0 (length (yard))"#)
        ...
        XCTAssertEqual(UnitIdentifier.parsec.description, #"0x27A1 (length (parsec))"#)
        ...
        XCTAssertEqual(UnitIdentifier.inch.description, #"0x27A2 (length (inch))"#)
        ...
        XCTAssertEqual(UnitIdentifier.foot.description, #"0x27A3 (length (foot))"#)
        ...
        XCTAssertEqual(UnitIdentifier.mile.description, #"0x27A4 (length (mile))"#)
        ...
        XCTAssertEqual(UnitIdentifier.pressurePoundForce.description, #"0x27A5 (pressure (pound-force per square inch))"#)
        ...
        XCTAssertEqual(UnitIdentifier.kilometrePerHour.description, #"0x27A6 (velocity (kilometre per hour))"#)
        ...
        XCTAssertEqual(UnitIdentifier.milePerHour.description, #"0x27A7 (velocity (mile per hour))"#)
        ...
        XCTAssertEqual(UnitIdentifier.revolutionPerMinute.description, #"0x27A8 (angular velocity (revolution per minute))"#)
        ...
        XCTAssertEqual(UnitIdentifier.gramCalorie.description, #"0x27A9 (energy (gram calorie))"#)
        ...
        XCTAssertEqual(UnitIdentifier.kilogramCalorie.description, #"0x27AA (energy (kilogram calorie))"#)
        ...
        XCTAssertEqual(UnitIdentifier.kilowattHour.description, #"0x27AB (energy (kilowatt hour))"#)
        ...
        XCTAssertEqual(UnitIdentifier.degreeFahrenheit.description, #"0x27AC (thermodynamic temperature (degree Fahrenheit))"#)
        ...
        XCTAssertEqual(UnitIdentifier.percentage.description, #"0x27AD (percentage)"#)
        ...
        XCTAssertEqual(UnitIdentifier.perMille.description, #"0x27AE (per mille)"#)
        ...
        XCTAssertEqual(UnitIdentifier.beatsPerMinute.description, #"0x27AF (period (beats per minute))"#)
        ...
        XCTAssertEqual(UnitIdentifier.ampereHours.description, #"0x27B0 (electric charge (ampere hours))"#)
        ...
        XCTAssertEqual(UnitIdentifier.milligramPerDecilitre.description, #"0x27B1 (mass density (milligram per decilitre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.millimolePerLitre.description, #"0x27B2 (mass density (millimole per litre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.year.description, #"0x27B3 (time (year))"#)
        ...
        XCTAssertEqual(UnitIdentifier.concentration.description, #"0x27B5 (concentration (count per cubic metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.irrandiance.description, #"0x27B6 (irradiance (watt per square metre))"#)
        ...
        XCTAssertEqual(UnitIdentifier.millilitre.description, #"0x27B7 (milliliter (per kilogram per minute))"#)
        ...
        XCTAssertEqual(UnitIdentifier.pound.description, #"0x27B8 (mass (pound))"#)
        ...
        XCTAssertEqual(UnitIdentifier.metabolicEquivalent.description, #"0x27B9 (metabolic equivalent)"#)
        ...
        XCTAssertEqual(UnitIdentifier.step.description, #"0x27BA (step (per minute))"#)
        ...
        XCTAssertEqual(UnitIdentifier.stroke.description, #"0x27BC (stroke (per minute))"#)
        ...
        XCTAssertEqual(UnitIdentifier.pace.description, #"0x27BD (pace (kilometre per minute))"#)
        ...
        XCTAssertEqual(UnitIdentifier.luminousEfficacy.description, #"0x27BE (luminous efficacy (lumen per watt))"#)
        ...
        XCTAssertEqual(UnitIdentifier.luminousEnergy.description, #"0x27BF (luminous energy (lumen hour))"#)
        ...
        XCTAssertEqual(UnitIdentifier.luminousExposure.description, #"0x27C0 (luminous exposure (lux hour))"#)
        ...
        XCTAssertEqual(UnitIdentifier.massFlow.description, #"0x27C1 (mass flow (gram per second))"#)
        ...
        XCTAssertEqual(UnitIdentifier.volumeFlow.description, #"0x27C2 (volume flow (litre per second))"#)
    
        // sound pressure (decibel)
        XCTAssertEqual(UnitIdentifier.soundPressure.rawValue, 0x27C3)
        XCTAssertEqual(UnitIdentifier.soundPressure.type, #"org.bluetooth.unit.sound_pressure.decibel_spl"#)
        XCTAssertEqual(UnitIdentifier.soundPressure.name, #"sound pressure (decibel)"#)
        XCTAssertEqual(UnitIdentifier.soundPressure.description, #"0x27C3 (sound pressure (decibel))"#)
    
        // parts per million
        XCTAssertEqual(UnitIdentifier.partsPerMillion.rawValue, 0x27C4)
        XCTAssertEqual(UnitIdentifier.partsPerMillion.type, #"org.bluetooth.unit.ppm"#)
        XCTAssertEqual(UnitIdentifier.partsPerMillion.name, #"parts per million"#)
        XCTAssertEqual(UnitIdentifier.partsPerMillion.description, #"0x27C4 (parts per million)"#)
    
        // parts per billion
        XCTAssertEqual(UnitIdentifier.partsPerBillion.rawValue, 0x27C5)
        XCTAssertEqual(UnitIdentifier.partsPerBillion.type, #"org.bluetooth.unit.ppb"#)
        XCTAssertEqual(UnitIdentifier.partsPerBillion.name, #"parts per billion"#)
        XCTAssertEqual(UnitIdentifier.partsPerBillion.description, #"0x27C5 (parts per billion)"#)
    
        // mass density rate ((milligram per decilitre) per minute)
        XCTAssertEqual(UnitIdentifier.massDensityRate.rawValue, 0x27C6)
        XCTAssertEqual(UnitIdentifier.massDensityRate.type, #"org.bluetooth.unit.mass_density_rate.milligram_per_decilitre_per_minute"#)
        XCTAssertEqual(UnitIdentifier.massDensityRate.name, #"mass density rate ((milligram per decilitre) per minute)"#)
        XCTAssertEqual(UnitIdentifier.massDensityRate.description, #"0x27C6 (mass density rate ((milligram per decilitre) per minute))"#)
    
        // Electrical Apparent Energy (kilovolt ampere hour)
        XCTAssertEqual(UnitIdentifier.kilovoltAmpereHour.rawValue, 0x27C7)
        XCTAssertEqual(UnitIdentifier.kilovoltAmpereHour.type, #"org.bluetooth.unit.energy.kilovolt_ampere_hour"#)
        XCTAssertEqual(UnitIdentifier.kilovoltAmpereHour.name, #"Electrical Apparent Energy (kilovolt ampere hour)"#)
        XCTAssertEqual(UnitIdentifier.kilovoltAmpereHour.description, #"0x27C7 (Electrical Apparent Energy (kilovolt ampere hour))"#)
    
        // Electrical Apparent Power (volt ampere)
        XCTAssertEqual(UnitIdentifier.voltAmpere.rawValue, 0x27C8)
        XCTAssertEqual(UnitIdentifier.voltAmpere.type, #"org.bluetooth.unit.power.volt_ampere"#)
        XCTAssertEqual(UnitIdentifier.voltAmpere.name, #"Electrical Apparent Power (volt ampere)"#)
        XCTAssertEqual(UnitIdentifier.voltAmpere.description, #"0x27C8 (Electrical Apparent Power (volt ampere))"#)
