...
final class BluetoothUUIDTests: XCTestCase {
    ...
    func testGenerateDefinedUUIDExtension() {
        ...
        var memberNameCache = [String: String]()
        ...
        //  Bluetooth
        //
        //  Generated by Alsey Coleman Miller on \(dateFormatter.string(from: Date())).
        //
        ...
        for (uuidValue, name) in uuids {
            ...
            while memberNameCache[memberName] != nil {
            ...
            memberNameCache[memberName] = name
        }
        
        🖨("}")
        
        let filename = NSTemporaryDirectory() + "DefinedUUIDExtension.swift"
