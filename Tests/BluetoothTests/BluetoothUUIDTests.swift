...
@Suite struct BluetoothUUIDTests {
    ...
    @Test func test128BitUUID() {
        ...
        guard let uuid = BluetoothUUID(rawValue: uuidString)
            ...
            Issue.record("Could not parse UUID string")
            return
        }
    ...
    @Test func definedUUID() throws {
        ...
        #expect(uuid != .bit32(0x1234_5678))

        #expect(
            Data(uuid.littleEndian)
                == Data([
                    uuidValue.littleEndian.bytes.0,
    ...
    @Test func test32BitUUID() throws {
        ...
        let uuidValue: UInt32 = 0x1234_5678
    ...
    @Test func test32BitBaseUUID() {
        ...
        let uuids: [UInt32: UUID] = [
            0x0000_1800: UUID(uuidString: "00001800-0000-1000-8000-00805F9B34FB")!,
            0x0000_1801: UUID(uuidString: "00001801-0000-1000-8000-00805F9B34FB")!,
            0x0000_FE59: UUID(uuidString: "0000FE59-0000-1000-8000-00805F9B34FB")!,
            0x0000_0000: UUID(uuidString: "00000000-0000-1000-8000-00805F9B34FB")!,
            0x1234_5678: UUID(uuidString: "12345678-0000-1000-8000-00805F9B34FB")!
        ]
    ...
    @Test func losslessStringConvertible() throws {
        ...
        let data: [(BluetoothUUID, String)] = [
            (.bit16(0x1800), "1800"),
            (.bit16(0xFEA9), "FEA9"),
            (.bit32(0x1234_5678).bit128, "12345678-0000-1000-8000-00805F9B34FB")
        ]
