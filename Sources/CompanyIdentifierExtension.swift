...
public extension CompanyIdentifier {
    ...
    static var broadcomCorporation: CompanyIdentifier {
    ...
    static var atmelCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 19)
    }

    /// Mitsubishi Electric Corporation (`20`)
    static var mitsubishiElectricCorporation: CompanyIdentifier {
    ...
    /// TTPCom Limited (`26`)
    static var ttpcomLimited: CompanyIdentifier {
    ...
    /// NEC Corporation (`34`)
    static var necCorporation: CompanyIdentifier {
    ...
    static var computerAccessTechnologyCorporationCatc: CompanyIdentifier {
    ...
    static var renesasElectronicsCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 54)
    }

    /// Mobilian Corporation (`55`)
    static var mobilianCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 55)
    }

    /// Syntronix Corporation (`56`)
    static var syntronixCorporation: CompanyIdentifier {
    ...
    static var gennumCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 59)
    }

    /// BlackBerry Limited (formerly Research In Motion) (`60`)
    static var blackberryLimitedFormerlyResearchInMotion: CompanyIdentifier {
    ...
    static var seikoEpsonCorporation: CompanyIdentifier {
    ...
    static var conwiseTechnologyCorporation: CompanyIdentifier {
    ...
    /// 3DSP Corporation (`73`)
    static var uuid3DspCorporation: CompanyIdentifier {
    ...
    /// J&M Corporation (`82`)
    static var jMCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 82)
    }

    /// Free2move AB (`83`)
    static var free2MoveAb: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 83)
    }

    /// 3DiJoy Corporation (`84`)
    static var uuid3DijoyCorporation: CompanyIdentifier {
    ...
    static var ralinkTechnologyCorporation: CompanyIdentifier {
    ...
    static var realtekSemiconductorCorporation: CompanyIdentifier {
    ...
    /// 9Solutions Oy (`102`)
    static var uuid9SolutionsOy: CompanyIdentifier {
    ...
    /// connectBlue AB (`113`)
    static var connectblueAb: CompanyIdentifier {
    ...
    static var boseCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 158)
    }

    /// Suunto Oy (`159`)
    static var suuntoOy: CompanyIdentifier {
    ...
    static var vertuCorporationLimited: CompanyIdentifier {
    ...
    static var visteonCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 167)
    }

    /// ARP Devices Limited (`168`)
    static var arpDevicesLimited: CompanyIdentifier {
    ...
    /// Omegawave Oy (`174`)
    static var omegawaveOy: CompanyIdentifier {
    ...
    static var passifSemiconductorCorp: CompanyIdentifier {
    ...
    static var sPowerElectronicsLimited: CompanyIdentifier {
    ...
    static var aplixCorporation: CompanyIdentifier {
    ...
    static var stalmartTechnologyLimited: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 191)
    }

    /// AMICCOM Electronics Corporation (`192`)
    static var amiccomElectronicsCorporation: CompanyIdentifier {
    ...
    static var onsetComputerCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 197)
    }

    /// Selfly BV (`198`)
    static var selflyBv: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 198)
    }

    /// Quuppa Oy. (`199`)
    static var quuppaOy: CompanyIdentifier {
    ...
    static var hosidenCorporation: CompanyIdentifier {
    ...
    static var misfitWearablesCorp: CompanyIdentifier {
    ...
    static var witronTechnologyLimited: CompanyIdentifier {
    ...
    /// Smartifier Oy (`245`)
    static var smartifierOy: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 245)
    }

    /// Elcometer Limited (`246`)
    static var elcometerLimited: CompanyIdentifier {
    ...
    /// Crystal Code AB (`250`)
    static var crystalCodeAb: CompanyIdentifier {
    ...
    static var delphiCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 252)
    }

    /// ValenceTech Limited (`253`)
    static var valencetechLimited: CompanyIdentifier {
    ...
    static var tomtomInternationalBv: CompanyIdentifier {
    ...
    static var keiserCorporation: CompanyIdentifier {
    ...
    static var ubiquitousComputingTechnologyCorporation: CompanyIdentifier {
    ...
    /// Atus BV (`265`)
    static var atusBv: CompanyIdentifier {
    ...
    static var fujitsuTenLimited: CompanyIdentifier {
    ...
    /// Steelseries ApS (`273`)
    static var steelseriesAps: CompanyIdentifier {
    ...
    static var nimbleDevicesOy: CompanyIdentifier {
    ...
    static var sonyCorporation: CompanyIdentifier {
    ...
    static var cypressSemiconductorCorporation: CompanyIdentifier {
    ...
    static var blueMaestroLimited: CompanyIdentifier {
    ...
    static var focusSystemsCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 313)
    }

    /// Tencent Holdings Limited (`314`)
    static var tencentHoldingsLimited: CompanyIdentifier {
    ...
    static var pioneerCorporation: CompanyIdentifier {
    ...
    /// Accumulate AB (`342`)
    static var accumulateAb: CompanyIdentifier {
    ...
    /// Inmite s.r.o. (`344`)
    static var inmiteSRO: CompanyIdentifier {
    ...
    static var cooperAtkinsCorporation: CompanyIdentifier {
    ...
    /// Volantic AB (`366`)
    static var volanticAb: CompanyIdentifier {
    ...
    static var connovateTechnologyPrivateLimited: CompanyIdentifier {
    ...
    static var xtelWirelessAps: CompanyIdentifier {
    ...
    static var ableTrendTechnologyLimited: CompanyIdentifier {
    ...
    static var acousticStreamCorporation: CompanyIdentifier {
    ...
    /// CUBETECH s.r.o. (`411`)
    static var cubetechSRO: CompanyIdentifier {
    ...
    static var earlensCorporation: CompanyIdentifier {
    ...
    static var cochlearBoneAnchoredSolutionsAb: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 443)
    }

    /// SenionLab AB (`444`)
    static var senionlabAb: CompanyIdentifier {
    ...
    static var hongKongHuntersunElectronicLimited: CompanyIdentifier {
    ...
    /// Bitcraze AB (`453`)
    static var bitcrazeAb: CompanyIdentifier {
    ...
    static var polyControlAps: CompanyIdentifier {
    ...
    static var laerdalMedicalAs: CompanyIdentifier {
    ...
    static var codeCorporation: CompanyIdentifier {
    ...
    static var minelabElectronicsPtyLimited: CompanyIdentifier {
    ...
    static var zebraTechnologiesCorporation: CompanyIdentifier {
    ...
    static var coolWebthingsLimited: CompanyIdentifier {
    ...
    static var gellinerLimited: CompanyIdentifier {
    ...
    static var radioSystemCorporation: CompanyIdentifier {
    ...
    /// Kemppi Oy (`515`)
    static var kemppiOy: CompanyIdentifier {
    ...
    static var jaguarLandRoverLimited: CompanyIdentifier {
    ...
    static var lukotonExperienceOy: CompanyIdentifier {
    ...
    /// Hiotech AB (`536`)
    static var hiotechAb: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 536)
    }

    /// DOTT Limited (`537`)
    static var dottLimited: CompanyIdentifier {
    ...
    static var manusMachinaBv: CompanyIdentifier {
    ...
    static var muovertiLimited: CompanyIdentifier {
    ...
    static var pharynksCorporation: CompanyIdentifier {
    ...
    /// Masimo Corp (`579`)
    static var masimoCorp: CompanyIdentifier {
    ...
    static var parkerHannifinCorp: CompanyIdentifier {
    ...
    static var g24PowerLimited: CompanyIdentifier {
    ...
    static var flukeCorporation: CompanyIdentifier {
    ...
    /// SMK Corporation (`613`)
    static var smkCorporation: CompanyIdentifier {
    ...
    static var torroxCoKg: CompanyIdentifier {
    ...
    /// FLEURBAEY BVBA (`622`)
    static var fleurbaeyBvba: CompanyIdentifier {
    ...
    /// Animas Corp (`625`)
    static var animasCorp: CompanyIdentifier {
    ...
    /// DEFA AS (`635`)
    static var defaAs: CompanyIdentifier {
    ...
    /// Jetro AS (`650`)
    static var jetroAs: CompanyIdentifier {
    ...
    /// RF Digital Corp (`654`)
    static var rfDigitalCorp: CompanyIdentifier {
    ...
    /// Multibit Oy (`656`)
    static var multibitOy: CompanyIdentifier {
    ...
    /// storm power ltd (`663`)
    static var stormPowerLtd: CompanyIdentifier {
    ...
    static var tendyronCorporation天地融科技股份有限公司: CompanyIdentifier {
    ...
    /// BBPOS Limited (`683`)
    static var bbposLimited: CompanyIdentifier {
    ...
    /// JouZen Oy (`690`)
    static var jouzenOy: CompanyIdentifier {
    ...
    static var hanshinElectricRailwayCoLtd: CompanyIdentifier {
    ...
    static var rinnaiCorporation: CompanyIdentifier {
    ...
    /// Koha.,Co.Ltd (`699`)
    static var kohaCoLtd: CompanyIdentifier {
    ...
    static var lineCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 705)
    }

    /// Guillemot Corporation (`706`)
    static var guillemotCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 706)
    }

    /// Techtronic Power Tools Technology Limited (`707`)
    static var techtronicPowerToolsTechnologyLimited: CompanyIdentifier {
    ...
    static var electronicsTomorrowLimited: CompanyIdentifier {
    ...
    static var bmaErgonomicsBV: CompanyIdentifier {
    ...
    /// Empatica Srl (`721`)
    static var empaticaSrl: CompanyIdentifier {
    ...
    static var powercastCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 723)
    }

    /// Secuyou ApS (`724`)
    static var secuyouAps: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 724)
    }

    /// OMRON Corporation (`725`)
    static var omronCorporation: CompanyIdentifier {
    ...
    static var nipponSystemwareCoLtd: CompanyIdentifier {
    ...
    static var victronEnergyBv: CompanyIdentifier {
    ...
    /// Fujitsu Limited (`746`)
    static var fujitsuLimited: CompanyIdentifier {
    ...
    /// HTC Corporation (`749`)
    static var htcCorporation: CompanyIdentifier {
    ...
    /// Runteq Oy Ltd (`760`)
    static var runteqOy: CompanyIdentifier {
    ...
    /// Swipp ApS (`773`)
    static var swippAps: CompanyIdentifier {
    ...
    static var fujiIndustrialCoLtd: CompanyIdentifier {
    ...
    static var agMeasurematicsPvt: CompanyIdentifier {
    ...
    /// Enterlab ApS (`797`)
    static var enterlabAps: CompanyIdentifier {
    ...
    static var compumedicsLimited: CompanyIdentifier {
    ...
    /// Corentium AS (`820`)
    static var corentiumAs: CompanyIdentifier {
    ...
    static var courtneyThorneLimited: CompanyIdentifier {
    ...
    static var tpvTechnologyLimited: CompanyIdentifier {
    ...
    static var toppanFormsCoLtd: CompanyIdentifier {
    ...
    static var eatonCorporation: CompanyIdentifier {
    ...
    static var insuletCorporation: CompanyIdentifier {
    ...
    static var faveroElectronicsSrl: CompanyIdentifier {
    ...
    /// Metormote AB (`872`)
    static var metormoteAb: CompanyIdentifier {
    ...
    static var brcontrolsProductsBv: CompanyIdentifier {
    ...
    /// Expain AS (`885`)
    static var expainAs: CompanyIdentifier {
    ...
    /// Plejd AB (`887`)
    static var plejdAb: CompanyIdentifier {
    ...
    static var cronologicsCorporation: CompanyIdentifier {
    ...
    static var sharpCorporation: CompanyIdentifier {
    ...
    static var kapschTrafficcomAb: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 904)
    }

    /// ActiveBlu Corporation (`905`)
    static var activebluCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 905)
    }

    /// Kohler Mira Limited (`906`)
    static var kohlerMiraLimited: CompanyIdentifier {
    ...
    /// INFOTECH s.r.o. (`912`)
    static var infotechSRO: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 912)
    }

    /// Thingsquare AB (`913`)
    static var thingsquareAb: CompanyIdentifier {
    ...
    static var nikonCorporation: CompanyIdentifier {
    ...
    static var schoolboardLimited: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 926)
    }

    /// Molex Corporation (`927`)
    static var molexCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 927)
    }

    /// IVT Wireless Limited (`928`)
    static var ivtWirelessLimited: CompanyIdentifier {
    ...
    static var commNSenseCorpDbaVerigo: CompanyIdentifier {
    ...
    static var propagationSystemsLimited: CompanyIdentifier {
    ...
    /// Alpha Nodus, inc. (`948`)
    static var alphaNodusInc: CompanyIdentifier {
    ...
    /// A-Safe Limited (`952`)
    static var aSafeLimited: CompanyIdentifier {
    ...
    static var maxscendMicroelectronicsCompanyLimited: CompanyIdentifier {
    ...
    static var casambiTechnologiesOy: CompanyIdentifier {
    ...
    static var in2ThingsAutomationPvt: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 970)
    }

    /// SYSDEV Srl (`971`)
    static var sysdevSrl: CompanyIdentifier {
    ...
    static var iotPotIndiaPrivateLimited: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 978)
    }

    /// Sigma Connectivity AB (`979`)
    static var sigmaConnectivityAb: CompanyIdentifier {
    ...
    static var actionsZhuhaiTechnologyLimited: CompanyIdentifier {
    ...
    /// Sensoan Oy (`994`)
    static var sensoanOy: CompanyIdentifier {
    ...
    static var iotInstrumentsOy: CompanyIdentifier {
    ...
    /// Flowscape AB (`1011`)
    static var flowscapeAb: CompanyIdentifier {
    ...
    static var searsHoldingsCorporation: CompanyIdentifier {
    ...
    static var senixCorporation: CompanyIdentifier {
    ...
    static var skfUKLimited: CompanyIdentifier {
    ...
    static var fridayLabsLimited: CompanyIdentifier {
    ...
    static var dellComputerCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1054)
    }

    /// Kopin Corporation (`1055`)
    static var kopinCorporation: CompanyIdentifier {
    ...
    static var chargifiLimited: CompanyIdentifier {
    ...
    /// Husqvarna AB (`1062`)
    static var husqvarnaAb: CompanyIdentifier {
    ...
    /// Meshtech AS (`1069`)
    static var meshtechAs: CompanyIdentifier {
    ...
    static var amwayCorporation: CompanyIdentifier {
    ...
    static var draysonTechnologiesEuropeLimited: CompanyIdentifier {
    ...
    static var nuhearaLimited: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1082)
    }

    /// Appside co., ltd. (`1083`)
    static var appsideCoLtd: CompanyIdentifier {
    ...
    static var coilerCorporation: CompanyIdentifier {
    ...
    /// iProtoXi Oy (`1089`)
    static var iprotoxiOy: CompanyIdentifier {
    ...
    static var metanateLimited: CompanyIdentifier {
    ...
    static var deltaTCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1116)
    }

    /// Boston Scientific Corporation (`1117`)
    static var bostonScientificCorporation: CompanyIdentifier {
    ...
    /// Codenex Oy (`1127`)
    static var codenexOy: CompanyIdentifier {
    ...
    /// Palago AB (`1129`)
    static var palagoAb: CompanyIdentifier {
    ...
    /// TiVo Corp (`1137`)
    static var tivoCorp: CompanyIdentifier {
    ...
    static var iapartmentCoLtd: CompanyIdentifier {
    ...
    static var oxstrenWearableTechnologiesPrivateLimited: CompanyIdentifier {
    ...
    static var farsiteCommunicationsLimited: CompanyIdentifier {
    ...
    static var quintraxLimited: CompanyIdentifier {
    ...
    /// Taelek Oy (`1162`)
    static var taelekOy: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1162)
    }

    /// CP Electronics Limited (`1163`)
    static var cpElectronicsLimited: CompanyIdentifier {
    ...
    /// Matting AB (`1168`)
    static var mattingAb: CompanyIdentifier {
    ...
    static var cochlearLimited: CompanyIdentifier {
    ...
    /// Situne AS (`1178`)
    static var situneAs: CompanyIdentifier {
    ...
    /// tictote AB (`1183`)
    static var tictoteAb: CompanyIdentifier {
    ...
    static var pniSensorCorporation: CompanyIdentifier {
    ...
    static var dallasLogicCorporation: CompanyIdentifier {
    ...
    static var kartographersTechnologiesPvt: CompanyIdentifier {
    ...
    static var mobikeHongKongLimited: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1203)
    }

    /// Inuheat Group AB (`1204`)
    static var inuheatGroupAb: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1204)
    }

    /// Swiftronix AB (`1205`)
    static var swiftronixAb: CompanyIdentifier {
    ...
    static var csrBuildingProductsLimited: CompanyIdentifier {
    ...
    /// Sospitas, s.r.o. (`1217`)
    static var sospitasSRO: CompanyIdentifier {
    ...
    static var mantracourtElectronicsLimited: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1219)
    }

    /// TeAM Hutchins AB (`1220`)
    static var teamHutchinsAb: CompanyIdentifier {
    ...
    static var olympusCorporation: CompanyIdentifier {
    ...
    /// Gooee Limited (`1237`)
    static var gooeeLimited: CompanyIdentifier {
    ...
    static var fujifilmCorporation: CompanyIdentifier {
    ...
    /// Avack Oy (`1253`)
    static var avackOy: CompanyIdentifier {
    ...
    /// Kosi Limited (`1264`)
    static var kosiLimited: CompanyIdentifier {
    ...
    static var indreamerTechsolPrivateLimited: CompanyIdentifier {
    ...
    /// McLear Limited (`1270`)
    static var mclearLimited: CompanyIdentifier {
    ...
    static var convergenceSystemsLimited: CompanyIdentifier {
    ...
    static var microsemiCorporation: CompanyIdentifier {
    ...
    /// Amcore AB (`1303`)
    static var amcoreAb: CompanyIdentifier {
    ...
    static var detectBlueLimited: CompanyIdentifier {
    ...
    static var targetCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1312)
    }

    /// IAI Corporation (`1313`)
    static var iaiCorporation: CompanyIdentifier {
    ...
    static var smartComponentTechnologiesLimited: CompanyIdentifier {
    ...
    static var metalogicsCorporation: CompanyIdentifier {
    ...
    /// Silergy Corp (`1343`)
    static var silergyCorp: CompanyIdentifier {
    ...
    static var smartTechnologiesAndInvestmentLimited: CompanyIdentifier {
    ...
    static var arwinTechnologyLimited: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1367)
    }

    /// benegear, inc. (`1368`)
    static var benegearInc: CompanyIdentifier {
    ...
    static var valveCorporation: CompanyIdentifier {
    ...
    /// BikeFinder AS (`1391`)
    static var bikefinderAs: CompanyIdentifier {
    ...
    static var ensembleTechPrivateLimited: CompanyIdentifier {
    ...
    static var aranzMedicalLimited: CompanyIdentifier {
    ...
    static var startTodayCoLtd: CompanyIdentifier {
    ...
    static var inorProcessAb: CompanyIdentifier {
    ...
    static var dataflowSystemsLimited: CompanyIdentifier {
    ...
    static var rcpSoftwareOy: CompanyIdentifier {
    ...
    /// Kiiroo BV (`1445`)
    static var kiirooBv: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1445)
    }

    /// Telecon Mobile Limited (`1446`)
    static var teleconMobileLimited: CompanyIdentifier {
    ...
    /// Tramex Limited (`1450`)
    static var tramexLimited: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1450)
    }

    /// Nofence AS (`1451`)
    static var nofenceAs: CompanyIdentifier {
    ...
    static var whiteHorseScientificLtd: CompanyIdentifier {
    ...
    static var realWorldSystemsCorporation: CompanyIdentifier {
    ...
    /// Lindab AB (`1489`)
    static var lindabAb: CompanyIdentifier {
    ...
    static var acurableLimited: CompanyIdentifier {
    ...
    static var toyoElectronicsCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1497)
    }

    /// Applied Neural Research Corp (`1498`)
    static var appliedNeuralResearchCorp: CompanyIdentifier {
    ...
    static var gycomSvenskaAb: CompanyIdentifier {
    ...
    /// SIKOM AS (`1519`)
    static var sikomAs: CompanyIdentifier {
    ...
    static var tryAndECoLtd: CompanyIdentifier {
    ...
    static var irobotCorporation: CompanyIdentifier {
    ...
    static var vuzixCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1548)
    }

    /// TDK Corporation (`1549`)
    static var tdkCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1549)
    }

    /// Blueair AB (`1550`)
    static var blueairAb: CompanyIdentifier {
    ...
    /// Playfinity AS (`1554`)
    static var playfinityAs: CompanyIdentifier {
    ...
    static var interActionCorporation: CompanyIdentifier {
    ...
    /// Forciot Oy (`1568`)
    static var forciotOy: CompanyIdentifier {
    ...
    static var philadelphiaScientificUKLimited: CompanyIdentifier {
    ...
    /// Ensto Oy (`1576`)
    static var enstoOy: CompanyIdentifier {
    ...
    static var onkyoCorporation: CompanyIdentifier {
        return CompanyIdentifier(rawValue: 1583)
    }

    /// Asthrea D.O.O. (`1584`)
    static var asthreaDOO: CompanyIdentifier {
    ...
    static var hugoMullerCoKg: CompanyIdentifier {
    ...
    /// Fanstel Corp (`1588`)
    static var fanstelCorp: CompanyIdentifier {
    ...
    static var prolojikLimited: CompanyIdentifier {
