...
public enum LowEnergyEvent: UInt8, HCIEvent {
    ...
    case periodicAdvertisingSyncTransferReceived = 0x18
...
public extension LowEnergyEvent {
    ...
    var name: String {
        ...
        case .periodicAdvertisingSyncTransferReceived: return "LE Periodic Advertising Sync Transfer Received Event"
